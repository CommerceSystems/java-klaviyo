...
public class Campaigns {
    ...
    public Campaigns withLinks(RelationshipLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = Optional.ofNullable(links);
        return this;
    }

    public Campaigns withLinks(Optional<? extends RelationshipLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Campaigns.class,
                "links", links);
    }
