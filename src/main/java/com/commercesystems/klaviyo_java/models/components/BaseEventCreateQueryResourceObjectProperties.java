...
/**
 * BaseEventCreateQueryResourceObjectProperties - Properties of this event. Any top level property (that are not objects) can be
...
public class BaseEventCreateQueryResourceObjectProperties {

    @JsonCreator
    public BaseEventCreateQueryResourceObjectProperties() {
    ...
    public String toString() {
        return Utils.toString(BaseEventCreateQueryResourceObjectProperties.class);
    }
    ...
    public final static class Builder {  
        ...
        public BaseEventCreateQueryResourceObjectProperties build() {
            return new BaseEventCreateQueryResourceObjectProperties(
                );
        }
    }
}
