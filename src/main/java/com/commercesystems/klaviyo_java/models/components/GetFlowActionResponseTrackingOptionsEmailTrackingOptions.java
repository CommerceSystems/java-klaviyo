...
public class GetFlowActionResponseTrackingOptionsEmailTrackingOptions {
    ...
    @JsonCreator
    public GetFlowActionResponseTrackingOptionsEmailTrackingOptions(
    ...
    public GetFlowActionResponseTrackingOptionsEmailTrackingOptions withAddUtm(boolean addUtm) {
        Utils.checkNotNull(addUtm, "addUtm");
        this.addUtm = addUtm;
        return this;
    }

    public GetFlowActionResponseTrackingOptionsEmailTrackingOptions withUtmParams(List<UtmParamInfo> utmParams) {
        Utils.checkNotNull(utmParams, "utmParams");
        this.utmParams = utmParams;
        return this;
    }

    public GetFlowActionResponseTrackingOptionsEmailTrackingOptions withIsTrackingOpens(boolean isTrackingOpens) {
        Utils.checkNotNull(isTrackingOpens, "isTrackingOpens");
        this.isTrackingOpens = isTrackingOpens;
        return this;
    }

    public GetFlowActionResponseTrackingOptionsEmailTrackingOptions withIsTrackingClicks(boolean isTrackingClicks) {
        Utils.checkNotNull(isTrackingClicks, "isTrackingClicks");
        this.isTrackingClicks = isTrackingClicks;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetFlowActionResponseTrackingOptionsEmailTrackingOptions other = (GetFlowActionResponseTrackingOptionsEmailTrackingOptions) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetFlowActionResponseTrackingOptionsEmailTrackingOptions.class,
                "addUtm", addUtm,
                "utmParams", utmParams,
    ...
    public final static class Builder {
        ...
        public GetFlowActionResponseTrackingOptionsEmailTrackingOptions build() {
            return new GetFlowActionResponseTrackingOptionsEmailTrackingOptions(
                addUtm,
                utmParams,
                isTrackingOpens,
                isTrackingClicks);
