...
public class SMSSendOptionsSubObject {
     ...
     * Use smart sending. Defaults to True
     */
    public SMSSendOptionsSubObject withUseSmartSending(boolean useSmartSending) {
        Utils.checkNotNull(useSmartSending, "useSmartSending");
     ...
     * Use smart sending. Defaults to True
     */
    public SMSSendOptionsSubObject withUseSmartSending(JsonNullable<Boolean> useSmartSending) {
        Utils.checkNotNull(useSmartSending, "useSmartSending");
        this.useSmartSending = useSmartSending;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SMSSendOptionsSubObject other = (SMSSendOptionsSubObject) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SMSSendOptionsSubObject.class,
    ...
    public final static class Builder {
        ...
        public SMSSendOptionsSubObject build() {
            return new SMSSendOptionsSubObject(
                useSmartSending);
        }
    }
}
