...
public class TrackingOptionsEmailTrackingOptions {
    ...
    @JsonCreator
    public TrackingOptionsEmailTrackingOptions(
    ...
    public TrackingOptionsEmailTrackingOptions withAddUtm(boolean addUtm) {
        Utils.checkNotNull(addUtm, "addUtm");
        this.addUtm = addUtm;
        return this;
    }

    public TrackingOptionsEmailTrackingOptions withUtmParams(List<UtmParamInfo> utmParams) {
        Utils.checkNotNull(utmParams, "utmParams");
        this.utmParams = utmParams;
        return this;
    }

    public TrackingOptionsEmailTrackingOptions withIsTrackingOpens(boolean isTrackingOpens) {
        Utils.checkNotNull(isTrackingOpens, "isTrackingOpens");
        this.isTrackingOpens = isTrackingOpens;
        return this;
    }

    public TrackingOptionsEmailTrackingOptions withIsTrackingClicks(boolean isTrackingClicks) {
        Utils.checkNotNull(isTrackingClicks, "isTrackingClicks");
        this.isTrackingClicks = isTrackingClicks;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TrackingOptionsEmailTrackingOptions other = (TrackingOptionsEmailTrackingOptions) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TrackingOptionsEmailTrackingOptions.class,
                "addUtm", addUtm,
                "utmParams", utmParams,
    ...
    public final static class Builder {
        ...
        public TrackingOptionsEmailTrackingOptions build() {
            return new TrackingOptionsEmailTrackingOptions(
                addUtm,
                utmParams,
                isTrackingOpens,
                isTrackingClicks);
