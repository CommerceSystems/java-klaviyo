...
public class OnsiteProfileMeta {
    ...
    public OnsiteProfileMeta withPatchProperties(ProfileMetaPatchProperties patchProperties) {
        Utils.checkNotNull(patchProperties, "patchProperties");
        this.patchProperties = Optional.ofNullable(patchProperties);
        return this;
    }

    public OnsiteProfileMeta withPatchProperties(Optional<? extends ProfileMetaPatchProperties> patchProperties) {
        Utils.checkNotNull(patchProperties, "patchProperties");
        this.patchProperties = patchProperties;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OnsiteProfileMeta other = (OnsiteProfileMeta) o;
        return 
    ...
    public String toString() {
        return Utils.toString(OnsiteProfileMeta.class,
    ...
    public final static class Builder {
        ...
        public OnsiteProfileMeta build() {
            return new OnsiteProfileMeta(
                patchProperties);
        }
    }
}
