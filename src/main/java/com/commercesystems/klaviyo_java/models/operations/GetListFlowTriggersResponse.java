...
public class GetListFlowTriggersResponse implements Response {
    ...
    @JsonCreator
    public GetListFlowTriggersResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetListFlowTriggersResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetListFlowTriggersResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetListFlowTriggersResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Success
     */
    public GetListFlowTriggersResponse withGetFlowResponseCollection(GetFlowResponseCollection getFlowResponseCollection) {
        Utils.checkNotNull(getFlowResponseCollection, "getFlowResponseCollection");
     ...
     * Success
     */
    public GetListFlowTriggersResponse withGetFlowResponseCollection(Optional<? extends GetFlowResponseCollection> getFlowResponseCollection) {
        Utils.checkNotNull(getFlowResponseCollection, "getFlowResponseCollection");
        this.getFlowResponseCollection = getFlowResponseCollection;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetListFlowTriggersResponse other = (GetListFlowTriggersResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetListFlowTriggersResponse.class,
    ...
    public final static class Builder {
        ...
        public GetListFlowTriggersResponse build() {
            return new GetListFlowTriggersResponse(
                contentType,
                statusCode,
                rawResponse,
                getFlowResponseCollection);
