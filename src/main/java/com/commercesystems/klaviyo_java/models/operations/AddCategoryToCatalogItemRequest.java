...
public class AddCategoryToCatalogItemRequest {
    ...
    @JsonCreator
    public AddCategoryToCatalogItemRequest(
            String id,
            String revision,
     ...
     * The catalog item ID is a compound ID (string), with format: `{integration}:::{catalog}:::{external_id}`. Currently, the only supported integration type is `$custom`, and the only supported catalog is `$default`.
     */
    public AddCategoryToCatalogItemRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public AddCategoryToCatalogItemRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }

    public AddCategoryToCatalogItemRequest withCatalogItemCategoryOp(CatalogItemCategoryOp catalogItemCategoryOp) {
        Utils.checkNotNull(catalogItemCategoryOp, "catalogItemCategoryOp");
        this.catalogItemCategoryOp = catalogItemCategoryOp;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddCategoryToCatalogItemRequest other = (AddCategoryToCatalogItemRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddCategoryToCatalogItemRequest.class,
                "id", id,
                "revision", revision,
                "catalogItemCategoryOp", catalogItemCategoryOp);
    }
    ...
    public final static class Builder {
        ...
        public AddCategoryToCatalogItemRequest build() {
            if (revision == null) {
                revision = _SINGLETON_VALUE_Revision.value();
            }            return new AddCategoryToCatalogItemRequest(
                id,
                revision,
                catalogItemCategoryOp);
        }
