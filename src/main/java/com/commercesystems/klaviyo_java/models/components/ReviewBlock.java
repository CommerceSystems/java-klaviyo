...
public class ReviewBlock {
    ...
    public ReviewBlock withContentType(BlockEnum contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }

    public ReviewBlock withType(ReviewEnum type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public ReviewBlock withData(String data) {
        Utils.checkNotNull(data, "data");
        this.data = Optional.ofNullable(data);
        return this;
    }

    public ReviewBlock withData(Optional<String> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ReviewBlock other = (ReviewBlock) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ReviewBlock.class,
