...
public class GetSegmentResponseCollectionAttributes {
    ...
    @JsonCreator
    public GetSegmentResponseCollectionAttributes(
     ...
     * A helpful name to label the segment
     */
    public GetSegmentResponseCollectionAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * A helpful name to label the segment
     */
    public GetSegmentResponseCollectionAttributes withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public GetSegmentResponseCollectionAttributes withDefinition(SegmentDefinition definition) {
        Utils.checkNotNull(definition, "definition");
        this.definition = Optional.ofNullable(definition);
        return this;
    }

    public GetSegmentResponseCollectionAttributes withDefinition(Optional<? extends SegmentDefinition> definition) {
        Utils.checkNotNull(definition, "definition");
        this.definition = definition;
        return this;
    }
     ...
     * Date and time when the segment was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public GetSegmentResponseCollectionAttributes withCreated(OffsetDateTime created) {
        Utils.checkNotNull(created, "created");
     ...
     * Date and time when the segment was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public GetSegmentResponseCollectionAttributes withCreated(JsonNullable<OffsetDateTime> created) {
        Utils.checkNotNull(created, "created");
        this.created = created;
        return this;
    }
     ...
     * Date and time when the segment was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public GetSegmentResponseCollectionAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
     ...
     * Date and time when the segment was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public GetSegmentResponseCollectionAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }

    public GetSegmentResponseCollectionAttributes withIsActive(boolean isActive) {
        Utils.checkNotNull(isActive, "isActive");
        this.isActive = isActive;
        return this;
    }

    public GetSegmentResponseCollectionAttributes withIsProcessing(boolean isProcessing) {
        Utils.checkNotNull(isProcessing, "isProcessing");
        this.isProcessing = isProcessing;
        return this;
    }

    public GetSegmentResponseCollectionAttributes withIsStarred(boolean isStarred) {
        Utils.checkNotNull(isStarred, "isStarred");
        this.isStarred = isStarred;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSegmentResponseCollectionAttributes other = (GetSegmentResponseCollectionAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSegmentResponseCollectionAttributes.class,
                "name", name,
    ...
    public final static class Builder {
        ...
        public GetSegmentResponseCollectionAttributes build() {
            return new GetSegmentResponseCollectionAttributes(
                name,
                definition,
                created,
                updated,
