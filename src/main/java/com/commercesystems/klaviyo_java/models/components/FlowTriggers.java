...
public class FlowTriggers {
    ...
    public FlowTriggers withLinks(RelationshipLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = Optional.ofNullable(links);
        return this;
    }

    public FlowTriggers withLinks(Optional<? extends RelationshipLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FlowTriggers other = (FlowTriggers) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FlowTriggers.class,
                "links", links);
    }
    ...
    public final static class Builder {
        ...
        public FlowTriggers build() {
            return new FlowTriggers(
                links);
        }
    }
}
