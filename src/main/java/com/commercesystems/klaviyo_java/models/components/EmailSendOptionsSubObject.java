...
public class EmailSendOptionsSubObject {
     ...
     * Use smart sending. Defaults to True
     */
    public EmailSendOptionsSubObject withUseSmartSending(boolean useSmartSending) {
        Utils.checkNotNull(useSmartSending, "useSmartSending");
     ...
     * Use smart sending. Defaults to True
     */
    public EmailSendOptionsSubObject withUseSmartSending(JsonNullable<Boolean> useSmartSending) {
        Utils.checkNotNull(useSmartSending, "useSmartSending");
        this.useSmartSending = useSmartSending;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EmailSendOptionsSubObject other = (EmailSendOptionsSubObject) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EmailSendOptionsSubObject.class,
    ...
    public final static class Builder {
        ...
        public EmailSendOptionsSubObject build() {
            return new EmailSendOptionsSubObject(
                useSmartSending);
        }
    }
}
