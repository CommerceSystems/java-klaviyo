...
public class CampaignsApiTest {
     ...
     */
    @Test
    public void assignTemplateToCampaignMessageTest() throws Exception {
        CampaignMessageAssignTemplateQuery body = null;
        String revision = null;
        PostCampaignMessageResponse response = api.assignTemplateToCampaignMessage(body, revision);
     ...
     */
    @Test
    public void cancelCampaignSendTest() throws Exception {
        CampaignSendJobPartialUpdateQuery body = null;
        String revision = null;
        String id = null;
        api.cancelCampaignSend(body, revision, id);
     ...
     */
    @Test
    public void getCampaignForCampaignMessageTest() throws Exception {
        String id = null;
        String revision = null;
        List<String> fieldsCampaign = null;
        GetCampaignResponse response = api.getCampaignForCampaignMessage(id, revision, fieldsCampaign);
     ...
     */
    @Test
    public void getCampaignIdForCampaignMessageTest() throws Exception {
        String id = null;
        String revision = null;
        GetCampaignMessageCampaignRelationshipResponse response = api.getCampaignIdForCampaignMessage(id, revision);
     ...
     */
    @Test
    public void getMessageIdsForCampaignTest() throws Exception {
        String id = null;
        String revision = null;
        GetCampaignMessagesRelationshipListResponseCollection response = api.getMessageIdsForCampaign(id, revision);
     ...
     */
    @Test
    public void getMessagesForCampaignTest() throws Exception {
        String id = null;
        String revision = null;
        List<String> fieldsCampaignMessage = null;
        List<String> fieldsCampaign = null;
        List<String> fieldsTemplate = null;
        List<String> include = null;
        GetCampaignMessageResponseCollectionCompoundDocument response = api.getMessagesForCampaign(id, revision, fieldsCampaignMessage, fieldsCampaign, fieldsTemplate, include);
     ...
     */
    @Test
    public void getTagIdsForCampaignTest() throws Exception {
        String id = null;
        String revision = null;
        GetCampaignTagRelationshipListResponseCollection response = api.getTagIdsForCampaign(id, revision);
     ...
     */
    @Test
    public void getTemplateForCampaignMessageTest() throws Exception {
        String id = null;
        String revision = null;
        List<String> fieldsTemplate = null;
        GetTemplateResponse response = api.getTemplateForCampaignMessage(id, revision, fieldsTemplate);
     ...
     */
    @Test
    public void getTemplateIdForCampaignMessageTest() throws Exception {
        String id = null;
        String revision = null;
        GetCampaignMessageTemplateRelationshipListResponse response = api.getTemplateIdForCampaignMessage(id, revision);
     ...
     */
    @Test
    public void refreshCampaignRecipientEstimationTest() throws Exception {
        CampaignRecipientEstimationJobCreateQuery body = null;
        String revision = null;
        PostCampaignRecipientEstimationJobResponse response = api.refreshCampaignRecipientEstimation(body, revision);
    ...
    public void sendCampaignTest() throws Exception {
        ...
        String revision = null;
        PostCampaignSendJobResponse response = api.sendCampaign(body, revision);
