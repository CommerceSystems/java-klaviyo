...
public class FlowActionResponseObjectResourceAttributes {
    ...
    private JsonNullable<? extends FlowActionResponseObjectResourceTrackingOptions> trackingOptions;
    ...
    @JsonCreator
    public FlowActionResponseObjectResourceAttributes(
            ...
            @JsonProperty("tracking_options") JsonNullable<? extends FlowActionResponseObjectResourceTrackingOptions> trackingOptions,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<FlowActionResponseObjectResourceTrackingOptions> trackingOptions() {
        return (JsonNullable<FlowActionResponseObjectResourceTrackingOptions>) trackingOptions;
    }
    ...
    public FlowActionResponseObjectResourceAttributes withActionType(String actionType) {
        Utils.checkNotNull(actionType, "actionType");
        this.actionType = JsonNullable.of(actionType);
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withActionType(JsonNullable<String> actionType) {
        Utils.checkNotNull(actionType, "actionType");
        this.actionType = actionType;
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = JsonNullable.of(status);
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withStatus(JsonNullable<String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withCreated(OffsetDateTime created) {
        Utils.checkNotNull(created, "created");
        this.created = JsonNullable.of(created);
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withCreated(JsonNullable<OffsetDateTime> created) {
        Utils.checkNotNull(created, "created");
        this.created = created;
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = JsonNullable.of(updated);
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withSettings(Settings settings) {
        Utils.checkNotNull(settings, "settings");
        this.settings = JsonNullable.of(settings);
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withSettings(JsonNullable<? extends Settings> settings) {
        Utils.checkNotNull(settings, "settings");
        this.settings = settings;
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withTrackingOptions(FlowActionResponseObjectResourceTrackingOptions trackingOptions) {
        Utils.checkNotNull(trackingOptions, "trackingOptions");
        this.trackingOptions = JsonNullable.of(trackingOptions);
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withTrackingOptions(JsonNullable<? extends FlowActionResponseObjectResourceTrackingOptions> trackingOptions) {
        Utils.checkNotNull(trackingOptions, "trackingOptions");
        this.trackingOptions = trackingOptions;
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withSendOptions(SendOptions sendOptions) {
        Utils.checkNotNull(sendOptions, "sendOptions");
        this.sendOptions = Optional.ofNullable(sendOptions);
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withSendOptions(Optional<? extends SendOptions> sendOptions) {
        Utils.checkNotNull(sendOptions, "sendOptions");
        this.sendOptions = sendOptions;
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withRenderOptions(SMSRenderOptions renderOptions) {
        Utils.checkNotNull(renderOptions, "renderOptions");
        this.renderOptions = Optional.ofNullable(renderOptions);
        return this;
    }

    public FlowActionResponseObjectResourceAttributes withRenderOptions(Optional<? extends SMSRenderOptions> renderOptions) {
        Utils.checkNotNull(renderOptions, "renderOptions");
        this.renderOptions = renderOptions;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FlowActionResponseObjectResourceAttributes other = (FlowActionResponseObjectResourceAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FlowActionResponseObjectResourceAttributes.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends FlowActionResponseObjectResourceTrackingOptions> trackingOptions = JsonNullable.undefined();
        ...
        public Builder trackingOptions(FlowActionResponseObjectResourceTrackingOptions trackingOptions) {
            Utils.checkNotNull(trackingOptions, "trackingOptions");
            this.trackingOptions = JsonNullable.of(trackingOptions);
            return this;
        }

        public Builder trackingOptions(JsonNullable<? extends FlowActionResponseObjectResourceTrackingOptions> trackingOptions) {
            Utils.checkNotNull(trackingOptions, "trackingOptions");
            this.trackingOptions = trackingOptions;
            return this;
        }
        ...
        public FlowActionResponseObjectResourceAttributes build() {
            return new FlowActionResponseObjectResourceAttributes(
                actionType,
                status,
                created,
                updated,
