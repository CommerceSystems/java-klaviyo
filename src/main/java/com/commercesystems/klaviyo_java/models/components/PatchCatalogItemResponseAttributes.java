...
public class PatchCatalogItemResponseAttributes {
    ...
    private JsonNullable<? extends PatchCatalogItemResponseCustomMetadata> customMetadata;
    ...
    @JsonCreator
    public PatchCatalogItemResponseAttributes(
            ...
            @JsonProperty("custom_metadata") JsonNullable<? extends PatchCatalogItemResponseCustomMetadata> customMetadata,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<PatchCatalogItemResponseCustomMetadata> customMetadata() {
        return (JsonNullable<PatchCatalogItemResponseCustomMetadata>) customMetadata;
    }
     ...
     * The ID of the catalog item in an external system.
     */
    public PatchCatalogItemResponseAttributes withExternalId(String externalId) {
        Utils.checkNotNull(externalId, "externalId");
     ...
     * The ID of the catalog item in an external system.
     */
    public PatchCatalogItemResponseAttributes withExternalId(JsonNullable<String> externalId) {
        Utils.checkNotNull(externalId, "externalId");
        this.externalId = externalId;
        return this;
    }
     ...
     * The title of the catalog item.
     */
    public PatchCatalogItemResponseAttributes withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the catalog item.
     */
    public PatchCatalogItemResponseAttributes withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A description of the catalog item.
     */
    public PatchCatalogItemResponseAttributes withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A description of the catalog item.
     */
    public PatchCatalogItemResponseAttributes withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * This field can be used to set the price on the catalog item, which is what gets displayed for the item when included in emails. For most price-update use cases, you will also want to update the `price` on any child variants, using the [Update Catalog Variant Endpoint](https://developers.klaviyo.com/en/reference/update_catalog_variant).
     */
    public PatchCatalogItemResponseAttributes withPrice(double price) {
        Utils.checkNotNull(price, "price");
     ...
     * This field can be used to set the price on the catalog item, which is what gets displayed for the item when included in emails. For most price-update use cases, you will also want to update the `price` on any child variants, using the [Update Catalog Variant Endpoint](https://developers.klaviyo.com/en/reference/update_catalog_variant).
     */
    public PatchCatalogItemResponseAttributes withPrice(JsonNullable<Double> price) {
        Utils.checkNotNull(price, "price");
        this.price = price;
        return this;
    }
     ...
     * URL pointing to the location of the catalog item on your website.
     */
    public PatchCatalogItemResponseAttributes withUrl(String url) {
        Utils.checkNotNull(url, "url");
     ...
     * URL pointing to the location of the catalog item on your website.
     */
    public PatchCatalogItemResponseAttributes withUrl(JsonNullable<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
     ...
     * URL pointing to the location of a full image of the catalog item.
     */
    public PatchCatalogItemResponseAttributes withImageFullUrl(String imageFullUrl) {
        Utils.checkNotNull(imageFullUrl, "imageFullUrl");
     ...
     * URL pointing to the location of a full image of the catalog item.
     */
    public PatchCatalogItemResponseAttributes withImageFullUrl(JsonNullable<String> imageFullUrl) {
        Utils.checkNotNull(imageFullUrl, "imageFullUrl");
        this.imageFullUrl = imageFullUrl;
        return this;
    }
     ...
     * URL pointing to the location of an image thumbnail of the catalog item
     */
    public PatchCatalogItemResponseAttributes withImageThumbnailUrl(String imageThumbnailUrl) {
        Utils.checkNotNull(imageThumbnailUrl, "imageThumbnailUrl");
     ...
     * URL pointing to the location of an image thumbnail of the catalog item
     */
    public PatchCatalogItemResponseAttributes withImageThumbnailUrl(JsonNullable<String> imageThumbnailUrl) {
        Utils.checkNotNull(imageThumbnailUrl, "imageThumbnailUrl");
        this.imageThumbnailUrl = imageThumbnailUrl;
        return this;
    }
     ...
     * List of URLs pointing to the locations of images of the catalog item.
     */
    public PatchCatalogItemResponseAttributes withImages(List<String> images) {
        Utils.checkNotNull(images, "images");
     ...
     * List of URLs pointing to the locations of images of the catalog item.
     */
    public PatchCatalogItemResponseAttributes withImages(JsonNullable<? extends List<String>> images) {
        Utils.checkNotNull(images, "images");
        this.images = images;
        return this;
    }
     ...
     * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
     */
    public PatchCatalogItemResponseAttributes withCustomMetadata(PatchCatalogItemResponseCustomMetadata customMetadata) {
        Utils.checkNotNull(customMetadata, "customMetadata");
     ...
     * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
     */
    public PatchCatalogItemResponseAttributes withCustomMetadata(JsonNullable<? extends PatchCatalogItemResponseCustomMetadata> customMetadata) {
        Utils.checkNotNull(customMetadata, "customMetadata");
        this.customMetadata = customMetadata;
        return this;
    }
     ...
     * Boolean value indicating whether the catalog item is published.
     */
    public PatchCatalogItemResponseAttributes withPublished(boolean published) {
        Utils.checkNotNull(published, "published");
     ...
     * Boolean value indicating whether the catalog item is published.
     */
    public PatchCatalogItemResponseAttributes withPublished(JsonNullable<Boolean> published) {
        Utils.checkNotNull(published, "published");
        this.published = published;
        return this;
    }
     ...
     * Date and time when the catalog item was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PatchCatalogItemResponseAttributes withCreated(OffsetDateTime created) {
        Utils.checkNotNull(created, "created");
     ...
     * Date and time when the catalog item was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PatchCatalogItemResponseAttributes withCreated(JsonNullable<OffsetDateTime> created) {
        Utils.checkNotNull(created, "created");
        this.created = created;
        return this;
    }
     ...
     * Date and time when the catalog item was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PatchCatalogItemResponseAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
     ...
     * Date and time when the catalog item was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PatchCatalogItemResponseAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchCatalogItemResponseAttributes other = (PatchCatalogItemResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchCatalogItemResponseAttributes.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends PatchCatalogItemResponseCustomMetadata> customMetadata = JsonNullable.undefined();
         ...
         * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
         */
        public Builder customMetadata(PatchCatalogItemResponseCustomMetadata customMetadata) {
            Utils.checkNotNull(customMetadata, "customMetadata");
            this.customMetadata = JsonNullable.of(customMetadata);
            return this;
        }
         ...
         * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
         */
        public Builder customMetadata(JsonNullable<? extends PatchCatalogItemResponseCustomMetadata> customMetadata) {
            Utils.checkNotNull(customMetadata, "customMetadata");
            this.customMetadata = customMetadata;
            return this;
        }
        ...
        public PatchCatalogItemResponseAttributes build() {
            return new PatchCatalogItemResponseAttributes(
                externalId,
                title,
                description,
                price,
