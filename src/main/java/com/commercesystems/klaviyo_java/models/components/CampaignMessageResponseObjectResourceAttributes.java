...
public class CampaignMessageResponseObjectResourceAttributes {
    ...
    @JsonCreator
    public CampaignMessageResponseObjectResourceAttributes(
     ...
     * The label or name on the message
     */
    public CampaignMessageResponseObjectResourceAttributes withLabel(String label) {
        Utils.checkNotNull(label, "label");
        this.label = label;
        return this;
    }
     ...
     * The channel the message is to be sent on
     */
    public CampaignMessageResponseObjectResourceAttributes withChannel(String channel) {
        Utils.checkNotNull(channel, "channel");
        this.channel = channel;
        return this;
    }
     ...
     * Additional attributes relating to the content of the message
     */
    public CampaignMessageResponseObjectResourceAttributes withContent(Content content) {
        Utils.checkNotNull(content, "content");
        this.content = content;
        return this;
    }
     ...
     * The list of appropriate Send Time Sub-objects associated with the message
     */
    public CampaignMessageResponseObjectResourceAttributes withSendTimes(List<SendTimeSubObject> sendTimes) {
        Utils.checkNotNull(sendTimes, "sendTimes");
     ...
     * The list of appropriate Send Time Sub-objects associated with the message
     */
    public CampaignMessageResponseObjectResourceAttributes withSendTimes(JsonNullable<? extends List<SendTimeSubObject>> sendTimes) {
        Utils.checkNotNull(sendTimes, "sendTimes");
        this.sendTimes = sendTimes;
        return this;
    }

    public CampaignMessageResponseObjectResourceAttributes withRenderOptions(RenderOptionsSubObject renderOptions) {
        Utils.checkNotNull(renderOptions, "renderOptions");
        this.renderOptions = Optional.ofNullable(renderOptions);
        return this;
    }

    public CampaignMessageResponseObjectResourceAttributes withRenderOptions(Optional<? extends RenderOptionsSubObject> renderOptions) {
        Utils.checkNotNull(renderOptions, "renderOptions");
        this.renderOptions = renderOptions;
        return this;
    }
     ...
     * The datetime when the message was created
     */
    public CampaignMessageResponseObjectResourceAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * The datetime when the message was created
     */
    public CampaignMessageResponseObjectResourceAttributes withCreatedAt(JsonNullable<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The datetime when the message was last updated
     */
    public CampaignMessageResponseObjectResourceAttributes withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
     ...
     * The datetime when the message was last updated
     */
    public CampaignMessageResponseObjectResourceAttributes withUpdatedAt(JsonNullable<OffsetDateTime> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CampaignMessageResponseObjectResourceAttributes other = (CampaignMessageResponseObjectResourceAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CampaignMessageResponseObjectResourceAttributes.class,
                "label", label,
                "channel", channel,
                "content", content,
                "sendTimes", sendTimes,
    ...
    public final static class Builder {
        ...
        public CampaignMessageResponseObjectResourceAttributes build() {
            return new CampaignMessageResponseObjectResourceAttributes(
                label,
                channel,
                content,
                sendTimes,
