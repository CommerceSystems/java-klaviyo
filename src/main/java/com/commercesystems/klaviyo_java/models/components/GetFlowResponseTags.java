...
public class GetFlowResponseTags {
    ...
    public GetFlowResponseTags withLinks(RelationshipLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = Optional.ofNullable(links);
        return this;
    }

    public GetFlowResponseTags withLinks(Optional<? extends RelationshipLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetFlowResponseTags other = (GetFlowResponseTags) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetFlowResponseTags.class,
                "links", links);
    }
    ...
    public final static class Builder {
        ...
        public GetFlowResponseTags build() {
            return new GetFlowResponseTags(
                links);
        }
    }
}
