...
public class GetCampaignResponseCompoundDocumentAttributes {
    ...
    private GetCampaignResponseCompoundDocumentSendOptions sendOptions;

    /**
     * The tracking options associated with the campaign
     */
    @JsonProperty("tracking_options")
    private GetCampaignResponseCompoundDocumentTrackingOptions trackingOptions;
    ...
    @JsonCreator
    public GetCampaignResponseCompoundDocumentAttributes(
            @JsonProperty("name") String name,
            @JsonProperty("status") String status,
            @JsonProperty("archived") boolean archived,
            @JsonProperty("audiences") AudiencesSubObject audiences,
            @JsonProperty("send_options") GetCampaignResponseCompoundDocumentSendOptions sendOptions,
            @JsonProperty("tracking_options") GetCampaignResponseCompoundDocumentTrackingOptions trackingOptions,
    ...
    public GetCampaignResponseCompoundDocumentAttributes(
            ...
            GetCampaignResponseCompoundDocumentSendOptions sendOptions,
            GetCampaignResponseCompoundDocumentTrackingOptions trackingOptions,
     ...
     */
    @JsonIgnore
    public GetCampaignResponseCompoundDocumentSendOptions sendOptions() {
        return sendOptions;
    }
     ...
     */
    @JsonIgnore
    public GetCampaignResponseCompoundDocumentTrackingOptions trackingOptions() {
     ...
     * The campaign name
     */
    public GetCampaignResponseCompoundDocumentAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The current status of the campaign
     */
    public GetCampaignResponseCompoundDocumentAttributes withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Whether the campaign has been archived or not
     */
    public GetCampaignResponseCompoundDocumentAttributes withArchived(boolean archived) {
        Utils.checkNotNull(archived, "archived");
        this.archived = archived;
        return this;
    }

    public GetCampaignResponseCompoundDocumentAttributes withAudiences(AudiencesSubObject audiences) {
        Utils.checkNotNull(audiences, "audiences");
        this.audiences = audiences;
        return this;
    }
     ...
     * Options to use when sending a campaign
     */
    public GetCampaignResponseCompoundDocumentAttributes withSendOptions(GetCampaignResponseCompoundDocumentSendOptions sendOptions) {
        Utils.checkNotNull(sendOptions, "sendOptions");
        this.sendOptions = sendOptions;
        return this;
    }
     ...
     * The tracking options associated with the campaign
     */
    public GetCampaignResponseCompoundDocumentAttributes withTrackingOptions(GetCampaignResponseCompoundDocumentTrackingOptions trackingOptions) {
        Utils.checkNotNull(trackingOptions, "trackingOptions");
        this.trackingOptions = trackingOptions;
        return this;
    }

    public GetCampaignResponseCompoundDocumentAttributes withSendStrategy(SendStrategySubObject sendStrategy) {
        Utils.checkNotNull(sendStrategy, "sendStrategy");
        this.sendStrategy = sendStrategy;
        return this;
    }
     ...
     * The datetime when the campaign was created
     */
    public GetCampaignResponseCompoundDocumentAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The datetime when the campaign was scheduled for future sending
     */
    public GetCampaignResponseCompoundDocumentAttributes withScheduledAt(OffsetDateTime scheduledAt) {
        Utils.checkNotNull(scheduledAt, "scheduledAt");
     ...
     * The datetime when the campaign was scheduled for future sending
     */
    public GetCampaignResponseCompoundDocumentAttributes withScheduledAt(JsonNullable<OffsetDateTime> scheduledAt) {
        Utils.checkNotNull(scheduledAt, "scheduledAt");
        this.scheduledAt = scheduledAt;
        return this;
    }
     ...
     * The datetime when the campaign was last updated by a user or the system
     */
    public GetCampaignResponseCompoundDocumentAttributes withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * The datetime when the campaign will be / was sent or None if not yet scheduled by a send_job.
     */
    public GetCampaignResponseCompoundDocumentAttributes withSendTime(OffsetDateTime sendTime) {
        Utils.checkNotNull(sendTime, "sendTime");
     ...
     * The datetime when the campaign will be / was sent or None if not yet scheduled by a send_job.
     */
    public GetCampaignResponseCompoundDocumentAttributes withSendTime(JsonNullable<OffsetDateTime> sendTime) {
        Utils.checkNotNull(sendTime, "sendTime");
        this.sendTime = sendTime;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCampaignResponseCompoundDocumentAttributes other = (GetCampaignResponseCompoundDocumentAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCampaignResponseCompoundDocumentAttributes.class,
                "name", name,
                "status", status,
                "archived", archived,
                "audiences", audiences,
    ...
    public final static class Builder {
         ...
         * Options to use when sending a campaign
         */
        public Builder sendOptions(GetCampaignResponseCompoundDocumentSendOptions sendOptions) {
            Utils.checkNotNull(sendOptions, "sendOptions");
            this.sendOptions = sendOptions;
            return this;
        }
         ...
         * The tracking options associated with the campaign
         */
        public Builder trackingOptions(GetCampaignResponseCompoundDocumentTrackingOptions trackingOptions) {
            Utils.checkNotNull(trackingOptions, "trackingOptions");
            this.trackingOptions = trackingOptions;
            return this;
        }
        ...
        public GetCampaignResponseCompoundDocumentAttributes build() {
            return new GetCampaignResponseCompoundDocumentAttributes(
                name,
                status,
                archived,
                audiences,
