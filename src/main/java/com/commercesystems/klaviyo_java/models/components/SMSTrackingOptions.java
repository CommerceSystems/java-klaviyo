...
public class SMSTrackingOptions {
    ...
    public SMSTrackingOptions withAddUtm(boolean addUtm) {
        Utils.checkNotNull(addUtm, "addUtm");
        this.addUtm = addUtm;
        return this;
    }

    public SMSTrackingOptions withUtmParams(List<UtmParamInfo> utmParams) {
        Utils.checkNotNull(utmParams, "utmParams");
        this.utmParams = utmParams;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SMSTrackingOptions other = (SMSTrackingOptions) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SMSTrackingOptions.class,
                "addUtm", addUtm,
                "utmParams", utmParams);
    }
    ...
    public final static class Builder {
        ...
        public SMSTrackingOptions build() {
            return new SMSTrackingOptions(
                addUtm,
                utmParams);
        }
    }
