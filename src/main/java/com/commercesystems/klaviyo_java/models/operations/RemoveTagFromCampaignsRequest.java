...
public class RemoveTagFromCampaignsRequest {
    ...
    @JsonCreator
    public RemoveTagFromCampaignsRequest(
            String id,
            String revision,
     ...
     * The Tag ID
     */
    public RemoveTagFromCampaignsRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public RemoveTagFromCampaignsRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }

    public RemoveTagFromCampaignsRequest withTagCampaignOp(TagCampaignOp tagCampaignOp) {
        Utils.checkNotNull(tagCampaignOp, "tagCampaignOp");
        this.tagCampaignOp = tagCampaignOp;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RemoveTagFromCampaignsRequest other = (RemoveTagFromCampaignsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RemoveTagFromCampaignsRequest.class,
                "id", id,
                "revision", revision,
                "tagCampaignOp", tagCampaignOp);
    }
    ...
    public final static class Builder {
        ...
        public RemoveTagFromCampaignsRequest build() {
            if (revision == null) {
                revision = _SINGLETON_VALUE_Revision.value();
            }            return new RemoveTagFromCampaignsRequest(
                id,
                revision,
                tagCampaignOp);
        }
