...
public class DeleteCatalogItemRequest {
     ...
     * The catalog item ID is a compound ID (string), with format: `{integration}:::{catalog}:::{external_id}`. Currently, the only supported integration type is `$custom`, and the only supported catalog is `$default`.
     */
    public DeleteCatalogItemRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public DeleteCatalogItemRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteCatalogItemRequest other = (DeleteCatalogItemRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteCatalogItemRequest.class,
                "id", id,
                "revision", revision);
    }
    ...
    public final static class Builder {
        ...
        public DeleteCatalogItemRequest build() {
            if (revision == null) {
