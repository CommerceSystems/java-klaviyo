...
/**
 * FormValuesRequestDTOResourceObjectStatistics - Defined form reporting metric
 */
public enum FormValuesRequestDTOResourceObjectStatistics {
    ...
    private FormValuesRequestDTOResourceObjectStatistics(String value) {
        this.value = value;
    }
