...
public class GetCategoryIdsForCatalogItemRequest {
    ...
    @JsonCreator
    public GetCategoryIdsForCatalogItemRequest(
            String id,
     ...
     * The catalog item ID is a compound ID (string), with format: `{integration}:::{catalog}:::{external_id}`. Currently, the only supported integration type is `$custom`, and the only supported catalog is `$default`.
     */
    public GetCategoryIdsForCatalogItemRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#pagination
     */
    public GetCategoryIdsForCatalogItemRequest withPageCursor(String pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#pagination
     */
    public GetCategoryIdsForCatalogItemRequest withPageCursor(Optional<String> pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
        this.pageCursor = pageCursor;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public GetCategoryIdsForCatalogItemRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCategoryIdsForCatalogItemRequest other = (GetCategoryIdsForCatalogItemRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCategoryIdsForCatalogItemRequest.class,
                "id", id,
    ...
    public final static class Builder {
        ...
        public GetCategoryIdsForCatalogItemRequest build() {
            if (revision == null) {
                revision = _SINGLETON_VALUE_Revision.value();
            }            return new GetCategoryIdsForCatalogItemRequest(
                id,
                pageCursor,
                revision);
        }
