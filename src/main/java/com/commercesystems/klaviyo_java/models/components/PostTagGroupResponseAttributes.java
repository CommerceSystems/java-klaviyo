...
public class PostTagGroupResponseAttributes {
    ...
    @JsonCreator
    public PostTagGroupResponseAttributes(
     ...
     * The Tag Group name
     */
    public PostTagGroupResponseAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * If a tag group is non-exclusive, any given related resource (campaign, flow, etc.) can be linked to multiple tags from that tag group. If a tag group is exclusive, any given related resource can only be linked to one tag from that tag group.
     */
    public PostTagGroupResponseAttributes withExclusive(boolean exclusive) {
        Utils.checkNotNull(exclusive, "exclusive");
        this.exclusive = exclusive;
        return this;
    }
     ...
     * Every company automatically has one Default Tag Group. The Default Tag Group cannot be deleted, and no other Default Tag Groups can be created. This value is true for the Default Tag Group and false for all other Tag Groups.
     */
    public PostTagGroupResponseAttributes withDefault(boolean default_) {
        Utils.checkNotNull(default_, "default_");
        this.default_ = default_;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostTagGroupResponseAttributes other = (PostTagGroupResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostTagGroupResponseAttributes.class,
                "name", name,
                "exclusive", exclusive,
                "default_", default_);
    }
    ...
    public final static class Builder {
        ...
        public PostTagGroupResponseAttributes build() {
            return new PostTagGroupResponseAttributes(
                name,
                exclusive,
                default_);
        }
