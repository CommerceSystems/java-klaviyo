...
public class CatalogItemResponseObjectResourceAttributes {
    ...
    private JsonNullable<? extends CatalogItemResponseObjectResourceCustomMetadata> customMetadata;
    ...
    @JsonCreator
    public CatalogItemResponseObjectResourceAttributes(
            ...
            @JsonProperty("custom_metadata") JsonNullable<? extends CatalogItemResponseObjectResourceCustomMetadata> customMetadata,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<CatalogItemResponseObjectResourceCustomMetadata> customMetadata() {
        return (JsonNullable<CatalogItemResponseObjectResourceCustomMetadata>) customMetadata;
    }
     ...
     * The ID of the catalog item in an external system.
     */
    public CatalogItemResponseObjectResourceAttributes withExternalId(String externalId) {
        Utils.checkNotNull(externalId, "externalId");
     ...
     * The ID of the catalog item in an external system.
     */
    public CatalogItemResponseObjectResourceAttributes withExternalId(JsonNullable<String> externalId) {
        Utils.checkNotNull(externalId, "externalId");
        this.externalId = externalId;
        return this;
    }
     ...
     * The title of the catalog item.
     */
    public CatalogItemResponseObjectResourceAttributes withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the catalog item.
     */
    public CatalogItemResponseObjectResourceAttributes withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * A description of the catalog item.
     */
    public CatalogItemResponseObjectResourceAttributes withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A description of the catalog item.
     */
    public CatalogItemResponseObjectResourceAttributes withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * This field can be used to set the price on the catalog item, which is what gets displayed for the item when included in emails. For most price-update use cases, you will also want to update the `price` on any child variants, using the [Update Catalog Variant Endpoint](https://developers.klaviyo.com/en/reference/update_catalog_variant).
     */
    public CatalogItemResponseObjectResourceAttributes withPrice(double price) {
        Utils.checkNotNull(price, "price");
     ...
     * This field can be used to set the price on the catalog item, which is what gets displayed for the item when included in emails. For most price-update use cases, you will also want to update the `price` on any child variants, using the [Update Catalog Variant Endpoint](https://developers.klaviyo.com/en/reference/update_catalog_variant).
     */
    public CatalogItemResponseObjectResourceAttributes withPrice(JsonNullable<Double> price) {
        Utils.checkNotNull(price, "price");
        this.price = price;
        return this;
    }
     ...
     * URL pointing to the location of the catalog item on your website.
     */
    public CatalogItemResponseObjectResourceAttributes withUrl(String url) {
        Utils.checkNotNull(url, "url");
     ...
     * URL pointing to the location of the catalog item on your website.
     */
    public CatalogItemResponseObjectResourceAttributes withUrl(JsonNullable<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
     ...
     * URL pointing to the location of a full image of the catalog item.
     */
    public CatalogItemResponseObjectResourceAttributes withImageFullUrl(String imageFullUrl) {
        Utils.checkNotNull(imageFullUrl, "imageFullUrl");
     ...
     * URL pointing to the location of a full image of the catalog item.
     */
    public CatalogItemResponseObjectResourceAttributes withImageFullUrl(JsonNullable<String> imageFullUrl) {
        Utils.checkNotNull(imageFullUrl, "imageFullUrl");
        this.imageFullUrl = imageFullUrl;
        return this;
    }
     ...
     * URL pointing to the location of an image thumbnail of the catalog item
     */
    public CatalogItemResponseObjectResourceAttributes withImageThumbnailUrl(String imageThumbnailUrl) {
        Utils.checkNotNull(imageThumbnailUrl, "imageThumbnailUrl");
     ...
     * URL pointing to the location of an image thumbnail of the catalog item
     */
    public CatalogItemResponseObjectResourceAttributes withImageThumbnailUrl(JsonNullable<String> imageThumbnailUrl) {
        Utils.checkNotNull(imageThumbnailUrl, "imageThumbnailUrl");
        this.imageThumbnailUrl = imageThumbnailUrl;
        return this;
    }
     ...
     * List of URLs pointing to the locations of images of the catalog item.
     */
    public CatalogItemResponseObjectResourceAttributes withImages(List<String> images) {
        Utils.checkNotNull(images, "images");
     ...
     * List of URLs pointing to the locations of images of the catalog item.
     */
    public CatalogItemResponseObjectResourceAttributes withImages(JsonNullable<? extends List<String>> images) {
        Utils.checkNotNull(images, "images");
        this.images = images;
        return this;
    }
     ...
     * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
     */
    public CatalogItemResponseObjectResourceAttributes withCustomMetadata(CatalogItemResponseObjectResourceCustomMetadata customMetadata) {
        Utils.checkNotNull(customMetadata, "customMetadata");
     ...
     * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
     */
    public CatalogItemResponseObjectResourceAttributes withCustomMetadata(JsonNullable<? extends CatalogItemResponseObjectResourceCustomMetadata> customMetadata) {
        Utils.checkNotNull(customMetadata, "customMetadata");
        this.customMetadata = customMetadata;
        return this;
    }
     ...
     * Boolean value indicating whether the catalog item is published.
     */
    public CatalogItemResponseObjectResourceAttributes withPublished(boolean published) {
        Utils.checkNotNull(published, "published");
     ...
     * Boolean value indicating whether the catalog item is published.
     */
    public CatalogItemResponseObjectResourceAttributes withPublished(JsonNullable<Boolean> published) {
        Utils.checkNotNull(published, "published");
        this.published = published;
        return this;
    }
     ...
     * Date and time when the catalog item was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public CatalogItemResponseObjectResourceAttributes withCreated(OffsetDateTime created) {
        Utils.checkNotNull(created, "created");
     ...
     * Date and time when the catalog item was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public CatalogItemResponseObjectResourceAttributes withCreated(JsonNullable<OffsetDateTime> created) {
        Utils.checkNotNull(created, "created");
        this.created = created;
        return this;
    }
     ...
     * Date and time when the catalog item was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public CatalogItemResponseObjectResourceAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
     ...
     * Date and time when the catalog item was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public CatalogItemResponseObjectResourceAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CatalogItemResponseObjectResourceAttributes other = (CatalogItemResponseObjectResourceAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CatalogItemResponseObjectResourceAttributes.class,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends CatalogItemResponseObjectResourceCustomMetadata> customMetadata = JsonNullable.undefined();
         ...
         * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
         */
        public Builder customMetadata(CatalogItemResponseObjectResourceCustomMetadata customMetadata) {
            Utils.checkNotNull(customMetadata, "customMetadata");
            this.customMetadata = JsonNullable.of(customMetadata);
            return this;
        }
         ...
         * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
         */
        public Builder customMetadata(JsonNullable<? extends CatalogItemResponseObjectResourceCustomMetadata> customMetadata) {
            Utils.checkNotNull(customMetadata, "customMetadata");
            this.customMetadata = customMetadata;
            return this;
        }
        ...
        public CatalogItemResponseObjectResourceAttributes build() {
            return new CatalogItemResponseObjectResourceAttributes(
                externalId,
                title,
                description,
                price,
