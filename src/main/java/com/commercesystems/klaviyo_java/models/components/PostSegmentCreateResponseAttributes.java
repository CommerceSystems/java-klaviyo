...
public class PostSegmentCreateResponseAttributes {
    ...
    @JsonCreator
    public PostSegmentCreateResponseAttributes(
     ...
     * A helpful name to label the segment
     */
    public PostSegmentCreateResponseAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * A helpful name to label the segment
     */
    public PostSegmentCreateResponseAttributes withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public PostSegmentCreateResponseAttributes withDefinition(SegmentDefinition definition) {
        Utils.checkNotNull(definition, "definition");
        this.definition = Optional.ofNullable(definition);
        return this;
    }

    public PostSegmentCreateResponseAttributes withDefinition(Optional<? extends SegmentDefinition> definition) {
        Utils.checkNotNull(definition, "definition");
        this.definition = definition;
        return this;
    }
     ...
     * Date and time when the segment was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PostSegmentCreateResponseAttributes withCreated(OffsetDateTime created) {
        Utils.checkNotNull(created, "created");
     ...
     * Date and time when the segment was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PostSegmentCreateResponseAttributes withCreated(JsonNullable<OffsetDateTime> created) {
        Utils.checkNotNull(created, "created");
        this.created = created;
        return this;
    }
     ...
     * Date and time when the segment was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PostSegmentCreateResponseAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
     ...
     * Date and time when the segment was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PostSegmentCreateResponseAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }

    public PostSegmentCreateResponseAttributes withIsActive(boolean isActive) {
        Utils.checkNotNull(isActive, "isActive");
        this.isActive = isActive;
        return this;
    }

    public PostSegmentCreateResponseAttributes withIsProcessing(boolean isProcessing) {
        Utils.checkNotNull(isProcessing, "isProcessing");
        this.isProcessing = isProcessing;
        return this;
    }

    public PostSegmentCreateResponseAttributes withIsStarred(boolean isStarred) {
        Utils.checkNotNull(isStarred, "isStarred");
        this.isStarred = isStarred;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostSegmentCreateResponseAttributes other = (PostSegmentCreateResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostSegmentCreateResponseAttributes.class,
                "name", name,
    ...
    public final static class Builder {
        ...
        public PostSegmentCreateResponseAttributes build() {
            return new PostSegmentCreateResponseAttributes(
                name,
                definition,
                created,
                updated,
