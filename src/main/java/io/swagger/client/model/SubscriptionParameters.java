...
public class SubscriptionParameters {
  ...
  public SubscriptionParameters consent(ConsentEnum consent) {
   ...
   * @return consent
  **/
  @Schema(example = "SUBSCRIBED", required = true, description = "The Consent status to be set as part of the subscribe call. Currently supports \"SUBSCRIBED\".")
  ...
  public SubscriptionParameters consentedAt(OffsetDateTime consentedAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionParameters subscriptionParameters = (SubscriptionParameters) o;
    return Objects.equals(this.consent, subscriptionParameters.consent) &&
        Objects.equals(this.consentedAt, subscriptionParameters.consentedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscriptionParameters {\n");
