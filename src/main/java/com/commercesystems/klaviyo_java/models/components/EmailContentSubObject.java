...
public class EmailContentSubObject {
     ...
     * The subject of the message
     */
    public EmailContentSubObject withSubject(String subject) {
        Utils.checkNotNull(subject, "subject");
     ...
     * The subject of the message
     */
    public EmailContentSubObject withSubject(JsonNullable<String> subject) {
        Utils.checkNotNull(subject, "subject");
        this.subject = subject;
        return this;
    }
     ...
     * Preview text associated with the message
     */
    public EmailContentSubObject withPreviewText(String previewText) {
        Utils.checkNotNull(previewText, "previewText");
     ...
     * Preview text associated with the message
     */
    public EmailContentSubObject withPreviewText(JsonNullable<String> previewText) {
        Utils.checkNotNull(previewText, "previewText");
        this.previewText = previewText;
        return this;
    }
     ...
     * The email the message should be sent from
     */
    public EmailContentSubObject withFromEmail(String fromEmail) {
        Utils.checkNotNull(fromEmail, "fromEmail");
     ...
     * The email the message should be sent from
     */
    public EmailContentSubObject withFromEmail(JsonNullable<String> fromEmail) {
        Utils.checkNotNull(fromEmail, "fromEmail");
        this.fromEmail = fromEmail;
        return this;
    }
     ...
     * The label associated with the from_email
     */
    public EmailContentSubObject withFromLabel(String fromLabel) {
        Utils.checkNotNull(fromLabel, "fromLabel");
     ...
     * The label associated with the from_email
     */
    public EmailContentSubObject withFromLabel(JsonNullable<String> fromLabel) {
        Utils.checkNotNull(fromLabel, "fromLabel");
        this.fromLabel = fromLabel;
        return this;
    }
     ...
     * Optional Reply-To email address
     */
    public EmailContentSubObject withReplyToEmail(String replyToEmail) {
        Utils.checkNotNull(replyToEmail, "replyToEmail");
     ...
     * Optional Reply-To email address
     */
    public EmailContentSubObject withReplyToEmail(JsonNullable<String> replyToEmail) {
        Utils.checkNotNull(replyToEmail, "replyToEmail");
        this.replyToEmail = replyToEmail;
        return this;
    }
     ...
     * Optional CC email address
     */
    public EmailContentSubObject withCcEmail(String ccEmail) {
        Utils.checkNotNull(ccEmail, "ccEmail");
     ...
     * Optional CC email address
     */
    public EmailContentSubObject withCcEmail(JsonNullable<String> ccEmail) {
        Utils.checkNotNull(ccEmail, "ccEmail");
        this.ccEmail = ccEmail;
        return this;
    }
     ...
     * Optional BCC email address
     */
    public EmailContentSubObject withBccEmail(String bccEmail) {
        Utils.checkNotNull(bccEmail, "bccEmail");
     ...
     * Optional BCC email address
     */
    public EmailContentSubObject withBccEmail(JsonNullable<String> bccEmail) {
        Utils.checkNotNull(bccEmail, "bccEmail");
        this.bccEmail = bccEmail;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EmailContentSubObject other = (EmailContentSubObject) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EmailContentSubObject.class,
                "subject", subject,
    ...
    public final static class Builder {
        ...
        public EmailContentSubObject build() {
            return new EmailContentSubObject(
                subject,
                previewText,
                fromEmail,
                fromLabel,
