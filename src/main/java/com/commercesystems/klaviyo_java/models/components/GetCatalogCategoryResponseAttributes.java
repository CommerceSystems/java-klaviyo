...
public class GetCatalogCategoryResponseAttributes {
    ...
    @JsonCreator
    public GetCatalogCategoryResponseAttributes(
     ...
     * The ID of the catalog category in an external system.
     */
    public GetCatalogCategoryResponseAttributes withExternalId(String externalId) {
        Utils.checkNotNull(externalId, "externalId");
     ...
     * The ID of the catalog category in an external system.
     */
    public GetCatalogCategoryResponseAttributes withExternalId(JsonNullable<String> externalId) {
        Utils.checkNotNull(externalId, "externalId");
        this.externalId = externalId;
        return this;
    }
     ...
     * The name of the catalog category.
     */
    public GetCatalogCategoryResponseAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the catalog category.
     */
    public GetCatalogCategoryResponseAttributes withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Date and time when the catalog category was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryResponseAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
     ...
     * Date and time when the catalog category was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryResponseAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCatalogCategoryResponseAttributes other = (GetCatalogCategoryResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCatalogCategoryResponseAttributes.class,
    ...
    public final static class Builder {
        ...
        public GetCatalogCategoryResponseAttributes build() {
            return new GetCatalogCategoryResponseAttributes(
                externalId,
                name,
                updated);
        }
