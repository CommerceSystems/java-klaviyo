...
public class GetMetricFlowTriggersResponse implements Response {
    ...
    @JsonCreator
    public GetMetricFlowTriggersResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetMetricFlowTriggersResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetMetricFlowTriggersResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetricFlowTriggersResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Success
     */
    public GetMetricFlowTriggersResponse withGetFlowResponseCollection(GetFlowResponseCollection getFlowResponseCollection) {
        Utils.checkNotNull(getFlowResponseCollection, "getFlowResponseCollection");
     ...
     * Success
     */
    public GetMetricFlowTriggersResponse withGetFlowResponseCollection(Optional<? extends GetFlowResponseCollection> getFlowResponseCollection) {
        Utils.checkNotNull(getFlowResponseCollection, "getFlowResponseCollection");
        this.getFlowResponseCollection = getFlowResponseCollection;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetricFlowTriggersResponse other = (GetMetricFlowTriggersResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetricFlowTriggersResponse.class,
    ...
    public final static class Builder {
        ...
        public GetMetricFlowTriggersResponse build() {
            return new GetMetricFlowTriggersResponse(
                contentType,
                statusCode,
                rawResponse,
                getFlowResponseCollection);
