...
/**
 * CampaignValuesRequestDTOResourceObjectStatistics - Defined reporting metric
 */
public enum CampaignValuesRequestDTOResourceObjectStatistics {
    ...
    private CampaignValuesRequestDTOResourceObjectStatistics(String value) {
        this.value = value;
    }
