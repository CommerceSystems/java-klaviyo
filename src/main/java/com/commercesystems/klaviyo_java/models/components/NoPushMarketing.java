...
public class NoPushMarketing {
    ...
    public NoPushMarketing withSubscription(AnyEnum subscription) {
        Utils.checkNotNull(subscription, "subscription");
        this.subscription = subscription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        NoPushMarketing other = (NoPushMarketing) o;
        return 
    ...
    public String toString() {
        return Utils.toString(NoPushMarketing.class,
    ...
    public final static class Builder {
        ...
        public NoPushMarketing build() {
            return new NoPushMarketing(
                subscription);
        }
    }
}
