...
public class GetMetricForMetricPropertyResponse implements Response {
    ...
    @JsonCreator
    public GetMetricForMetricPropertyResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetMetricForMetricPropertyResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetMetricForMetricPropertyResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetricForMetricPropertyResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Success
     */
    public GetMetricForMetricPropertyResponse withGetMetricResponse(GetMetricResponse getMetricResponse) {
        Utils.checkNotNull(getMetricResponse, "getMetricResponse");
     ...
     * Success
     */
    public GetMetricForMetricPropertyResponse withGetMetricResponse(Optional<? extends GetMetricResponse> getMetricResponse) {
        Utils.checkNotNull(getMetricResponse, "getMetricResponse");
        this.getMetricResponse = getMetricResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetricForMetricPropertyResponse other = (GetMetricForMetricPropertyResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetricForMetricPropertyResponse.class,
    ...
    public final static class Builder {
        ...
        public GetMetricForMetricPropertyResponse build() {
            return new GetMetricForMetricPropertyResponse(
                contentType,
                statusCode,
                rawResponse,
                getMetricResponse);
