...
public class PatchTrackingSettingResponseAttributes {
    ...
    @JsonCreator
    public PatchTrackingSettingResponseAttributes(
     ...
     * Whether tracking parameters are automatically added to campaigns and flows.
     */
    public PatchTrackingSettingResponseAttributes withAutoAddParameters(boolean autoAddParameters) {
        Utils.checkNotNull(autoAddParameters, "autoAddParameters");
        this.autoAddParameters = autoAddParameters;
        return this;
    }

    public PatchTrackingSettingResponseAttributes withUtmSource(TrackingParamDTO utmSource) {
        Utils.checkNotNull(utmSource, "utmSource");
        this.utmSource = utmSource;
        return this;
    }

    public PatchTrackingSettingResponseAttributes withUtmMedium(TrackingParamDTO utmMedium) {
        Utils.checkNotNull(utmMedium, "utmMedium");
        this.utmMedium = utmMedium;
        return this;
    }

    public PatchTrackingSettingResponseAttributes withUtmCampaign(TrackingParamDTO utmCampaign) {
        Utils.checkNotNull(utmCampaign, "utmCampaign");
        this.utmCampaign = Optional.ofNullable(utmCampaign);
        return this;
    }

    public PatchTrackingSettingResponseAttributes withUtmCampaign(Optional<? extends TrackingParamDTO> utmCampaign) {
        Utils.checkNotNull(utmCampaign, "utmCampaign");
        this.utmCampaign = utmCampaign;
        return this;
    }

    public PatchTrackingSettingResponseAttributes withUtmId(TrackingParamDTO utmId) {
        Utils.checkNotNull(utmId, "utmId");
        this.utmId = Optional.ofNullable(utmId);
        return this;
    }

    public PatchTrackingSettingResponseAttributes withUtmId(Optional<? extends TrackingParamDTO> utmId) {
        Utils.checkNotNull(utmId, "utmId");
        this.utmId = utmId;
        return this;
    }

    public PatchTrackingSettingResponseAttributes withUtmTerm(TrackingParamDTO utmTerm) {
        Utils.checkNotNull(utmTerm, "utmTerm");
        this.utmTerm = Optional.ofNullable(utmTerm);
        return this;
    }

    public PatchTrackingSettingResponseAttributes withUtmTerm(Optional<? extends TrackingParamDTO> utmTerm) {
        Utils.checkNotNull(utmTerm, "utmTerm");
        this.utmTerm = utmTerm;
        return this;
    }
     ...
     * Additional custom tracking parameters.
     */
    public PatchTrackingSettingResponseAttributes withCustomParameters(List<CustomTrackingParamDTO> customParameters) {
        Utils.checkNotNull(customParameters, "customParameters");
     ...
     * Additional custom tracking parameters.
     */
    public PatchTrackingSettingResponseAttributes withCustomParameters(JsonNullable<? extends List<CustomTrackingParamDTO>> customParameters) {
        Utils.checkNotNull(customParameters, "customParameters");
        this.customParameters = customParameters;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchTrackingSettingResponseAttributes other = (PatchTrackingSettingResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchTrackingSettingResponseAttributes.class,
    ...
    public final static class Builder {
        ...
        public PatchTrackingSettingResponseAttributes build() {
            return new PatchTrackingSettingResponseAttributes(
                autoAddParameters,
                utmSource,
                utmMedium,
                utmCampaign,
