...
public class GetBulkUpdateCatalogItemsJobsRequest {
    ...
    private Optional<? extends List<FieldsCatalogItemBulkUpdateJob>> fieldsCatalogItemBulkUpdateJob;
    ...
    @JsonCreator
    public GetBulkUpdateCatalogItemsJobsRequest(
    ...
    @JsonIgnore
    public Optional<List<FieldsCatalogItemBulkUpdateJob>> fieldsCatalogItemBulkUpdateJob() {
        return (Optional<List<FieldsCatalogItemBulkUpdateJob>>) fieldsCatalogItemBulkUpdateJob;
    }
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
     */
    public GetBulkUpdateCatalogItemsJobsRequest withFieldsCatalogItemBulkUpdateJob(List<FieldsCatalogItemBulkUpdateJob> fieldsCatalogItemBulkUpdateJob) {
        Utils.checkNotNull(fieldsCatalogItemBulkUpdateJob, "fieldsCatalogItemBulkUpdateJob");
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
     */
    public GetBulkUpdateCatalogItemsJobsRequest withFieldsCatalogItemBulkUpdateJob(Optional<? extends List<FieldsCatalogItemBulkUpdateJob>> fieldsCatalogItemBulkUpdateJob) {
        Utils.checkNotNull(fieldsCatalogItemBulkUpdateJob, "fieldsCatalogItemBulkUpdateJob");
        this.fieldsCatalogItemBulkUpdateJob = fieldsCatalogItemBulkUpdateJob;
        return this;
    }
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;`status`: `equals`
     */
    public GetBulkUpdateCatalogItemsJobsRequest withFilter(String filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;`status`: `equals`
     */
    public GetBulkUpdateCatalogItemsJobsRequest withFilter(Optional<String> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#pagination
     */
    public GetBulkUpdateCatalogItemsJobsRequest withPageCursor(String pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#pagination
     */
    public GetBulkUpdateCatalogItemsJobsRequest withPageCursor(Optional<String> pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
        this.pageCursor = pageCursor;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public GetBulkUpdateCatalogItemsJobsRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetBulkUpdateCatalogItemsJobsRequest other = (GetBulkUpdateCatalogItemsJobsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetBulkUpdateCatalogItemsJobsRequest.class,
    ...
    public final static class Builder {
         ...
         * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
         */
        public Builder fieldsCatalogItemBulkUpdateJob(List<FieldsCatalogItemBulkUpdateJob> fieldsCatalogItemBulkUpdateJob) {
            Utils.checkNotNull(fieldsCatalogItemBulkUpdateJob, "fieldsCatalogItemBulkUpdateJob");
            this.fieldsCatalogItemBulkUpdateJob = Optional.ofNullable(fieldsCatalogItemBulkUpdateJob);
            return this;
        }
         ...
         * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
         */
        public Builder fieldsCatalogItemBulkUpdateJob(Optional<? extends List<FieldsCatalogItemBulkUpdateJob>> fieldsCatalogItemBulkUpdateJob) {
            Utils.checkNotNull(fieldsCatalogItemBulkUpdateJob, "fieldsCatalogItemBulkUpdateJob");
            this.fieldsCatalogItemBulkUpdateJob = fieldsCatalogItemBulkUpdateJob;
            return this;
        }
        ...
        public GetBulkUpdateCatalogItemsJobsRequest build() {
            if (revision == null) {
                revision = _SINGLETON_VALUE_Revision.value();
            }            return new GetBulkUpdateCatalogItemsJobsRequest(
                fieldsCatalogItemBulkUpdateJob,
                filter,
                pageCursor,
                revision);
