...
public class PatchCampaignResponseAttributes {
    ...
    private PatchCampaignResponseSendOptions sendOptions;

    /**
     * The tracking options associated with the campaign
     */
    @JsonProperty("tracking_options")
    private PatchCampaignResponseTrackingOptions trackingOptions;
    ...
    @JsonCreator
    public PatchCampaignResponseAttributes(
            @JsonProperty("name") String name,
            @JsonProperty("status") String status,
            @JsonProperty("archived") boolean archived,
            @JsonProperty("audiences") AudiencesSubObject audiences,
            @JsonProperty("send_options") PatchCampaignResponseSendOptions sendOptions,
            @JsonProperty("tracking_options") PatchCampaignResponseTrackingOptions trackingOptions,
    ...
    public PatchCampaignResponseAttributes(
            ...
            PatchCampaignResponseSendOptions sendOptions,
            PatchCampaignResponseTrackingOptions trackingOptions,
     ...
     */
    @JsonIgnore
    public PatchCampaignResponseSendOptions sendOptions() {
        return sendOptions;
    }
     ...
     */
    @JsonIgnore
    public PatchCampaignResponseTrackingOptions trackingOptions() {
     ...
     * The campaign name
     */
    public PatchCampaignResponseAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The current status of the campaign
     */
    public PatchCampaignResponseAttributes withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Whether the campaign has been archived or not
     */
    public PatchCampaignResponseAttributes withArchived(boolean archived) {
        Utils.checkNotNull(archived, "archived");
        this.archived = archived;
        return this;
    }

    public PatchCampaignResponseAttributes withAudiences(AudiencesSubObject audiences) {
        Utils.checkNotNull(audiences, "audiences");
        this.audiences = audiences;
        return this;
    }
     ...
     * Options to use when sending a campaign
     */
    public PatchCampaignResponseAttributes withSendOptions(PatchCampaignResponseSendOptions sendOptions) {
        Utils.checkNotNull(sendOptions, "sendOptions");
        this.sendOptions = sendOptions;
        return this;
    }
     ...
     * The tracking options associated with the campaign
     */
    public PatchCampaignResponseAttributes withTrackingOptions(PatchCampaignResponseTrackingOptions trackingOptions) {
        Utils.checkNotNull(trackingOptions, "trackingOptions");
        this.trackingOptions = trackingOptions;
        return this;
    }

    public PatchCampaignResponseAttributes withSendStrategy(SendStrategySubObject sendStrategy) {
        Utils.checkNotNull(sendStrategy, "sendStrategy");
        this.sendStrategy = sendStrategy;
        return this;
    }
     ...
     * The datetime when the campaign was created
     */
    public PatchCampaignResponseAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The datetime when the campaign was scheduled for future sending
     */
    public PatchCampaignResponseAttributes withScheduledAt(OffsetDateTime scheduledAt) {
        Utils.checkNotNull(scheduledAt, "scheduledAt");
     ...
     * The datetime when the campaign was scheduled for future sending
     */
    public PatchCampaignResponseAttributes withScheduledAt(JsonNullable<OffsetDateTime> scheduledAt) {
        Utils.checkNotNull(scheduledAt, "scheduledAt");
        this.scheduledAt = scheduledAt;
        return this;
    }
     ...
     * The datetime when the campaign was last updated by a user or the system
     */
    public PatchCampaignResponseAttributes withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * The datetime when the campaign will be / was sent or None if not yet scheduled by a send_job.
     */
    public PatchCampaignResponseAttributes withSendTime(OffsetDateTime sendTime) {
        Utils.checkNotNull(sendTime, "sendTime");
     ...
     * The datetime when the campaign will be / was sent or None if not yet scheduled by a send_job.
     */
    public PatchCampaignResponseAttributes withSendTime(JsonNullable<OffsetDateTime> sendTime) {
        Utils.checkNotNull(sendTime, "sendTime");
        this.sendTime = sendTime;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchCampaignResponseAttributes other = (PatchCampaignResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchCampaignResponseAttributes.class,
                "name", name,
                "status", status,
                "archived", archived,
                "audiences", audiences,
    ...
    public final static class Builder {
         ...
         * Options to use when sending a campaign
         */
        public Builder sendOptions(PatchCampaignResponseSendOptions sendOptions) {
            Utils.checkNotNull(sendOptions, "sendOptions");
            this.sendOptions = sendOptions;
            return this;
        }
         ...
         * The tracking options associated with the campaign
         */
        public Builder trackingOptions(PatchCampaignResponseTrackingOptions trackingOptions) {
            Utils.checkNotNull(trackingOptions, "trackingOptions");
            this.trackingOptions = trackingOptions;
            return this;
        }
        ...
        public PatchCampaignResponseAttributes build() {
            return new PatchCampaignResponseAttributes(
                name,
                status,
                archived,
                audiences,
