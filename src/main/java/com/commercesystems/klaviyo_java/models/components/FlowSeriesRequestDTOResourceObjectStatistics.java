...
/**
 * FlowSeriesRequestDTOResourceObjectStatistics - Defined reporting metric
 */
public enum FlowSeriesRequestDTOResourceObjectStatistics {
    ...
    private FlowSeriesRequestDTOResourceObjectStatistics(String value) {
        this.value = value;
    }
