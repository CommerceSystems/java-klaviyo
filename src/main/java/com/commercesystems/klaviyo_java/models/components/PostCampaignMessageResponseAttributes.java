...
public class PostCampaignMessageResponseAttributes {
    ...
    private PostCampaignMessageResponseContent content;
    ...
    @JsonCreator
    public PostCampaignMessageResponseAttributes(
            @JsonProperty("label") String label,
            @JsonProperty("channel") String channel,
            @JsonProperty("content") PostCampaignMessageResponseContent content,
    ...
    public PostCampaignMessageResponseAttributes(
            String label,
            String channel,
            PostCampaignMessageResponseContent content) {
     ...
     */
    @JsonIgnore
    public PostCampaignMessageResponseContent content() {
        return content;
    }
     ...
     * The label or name on the message
     */
    public PostCampaignMessageResponseAttributes withLabel(String label) {
        Utils.checkNotNull(label, "label");
        this.label = label;
        return this;
    }
     ...
     * The channel the message is to be sent on
     */
    public PostCampaignMessageResponseAttributes withChannel(String channel) {
        Utils.checkNotNull(channel, "channel");
        this.channel = channel;
        return this;
    }
     ...
     * Additional attributes relating to the content of the message
     */
    public PostCampaignMessageResponseAttributes withContent(PostCampaignMessageResponseContent content) {
        Utils.checkNotNull(content, "content");
        this.content = content;
        return this;
    }
     ...
     * The list of appropriate Send Time Sub-objects associated with the message
     */
    public PostCampaignMessageResponseAttributes withSendTimes(List<SendTimeSubObject> sendTimes) {
        Utils.checkNotNull(sendTimes, "sendTimes");
     ...
     * The list of appropriate Send Time Sub-objects associated with the message
     */
    public PostCampaignMessageResponseAttributes withSendTimes(JsonNullable<? extends List<SendTimeSubObject>> sendTimes) {
        Utils.checkNotNull(sendTimes, "sendTimes");
        this.sendTimes = sendTimes;
        return this;
    }

    public PostCampaignMessageResponseAttributes withRenderOptions(RenderOptionsSubObject renderOptions) {
        Utils.checkNotNull(renderOptions, "renderOptions");
        this.renderOptions = Optional.ofNullable(renderOptions);
        return this;
    }

    public PostCampaignMessageResponseAttributes withRenderOptions(Optional<? extends RenderOptionsSubObject> renderOptions) {
        Utils.checkNotNull(renderOptions, "renderOptions");
        this.renderOptions = renderOptions;
        return this;
    }
     ...
     * The datetime when the message was created
     */
    public PostCampaignMessageResponseAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * The datetime when the message was created
     */
    public PostCampaignMessageResponseAttributes withCreatedAt(JsonNullable<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The datetime when the message was last updated
     */
    public PostCampaignMessageResponseAttributes withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
     ...
     * The datetime when the message was last updated
     */
    public PostCampaignMessageResponseAttributes withUpdatedAt(JsonNullable<OffsetDateTime> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostCampaignMessageResponseAttributes other = (PostCampaignMessageResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostCampaignMessageResponseAttributes.class,
                "label", label,
                "channel", channel,
                "content", content,
                "sendTimes", sendTimes,
    ...
    public final static class Builder {
         ...
         * Additional attributes relating to the content of the message
         */
        public Builder content(PostCampaignMessageResponseContent content) {
            Utils.checkNotNull(content, "content");
            this.content = content;
            return this;
        }
        ...
        public PostCampaignMessageResponseAttributes build() {
            return new PostCampaignMessageResponseAttributes(
                label,
                channel,
                content,
                sendTimes,
