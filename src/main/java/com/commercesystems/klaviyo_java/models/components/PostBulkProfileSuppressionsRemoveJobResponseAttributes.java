...
public class PostBulkProfileSuppressionsRemoveJobResponseAttributes {

    /**
     * Status of the asynchronous job.
     */
    @JsonProperty("status")
    private PostBulkProfileSuppressionsRemoveJobResponseStatus status;
    ...
    @JsonCreator
    public PostBulkProfileSuppressionsRemoveJobResponseAttributes(
            @JsonProperty("status") PostBulkProfileSuppressionsRemoveJobResponseStatus status,
    ...
    public PostBulkProfileSuppressionsRemoveJobResponseAttributes(
            PostBulkProfileSuppressionsRemoveJobResponseStatus status,
     ...
     */
    @JsonIgnore
    public PostBulkProfileSuppressionsRemoveJobResponseStatus status() {
        return status;
    }
     ...
     * Status of the asynchronous job.
     */
    public PostBulkProfileSuppressionsRemoveJobResponseAttributes withStatus(PostBulkProfileSuppressionsRemoveJobResponseStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The date and time the job was created in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PostBulkProfileSuppressionsRemoveJobResponseAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The total number of operations to be processed by the job. See `completed_count` for the job's current progress.
     */
    public PostBulkProfileSuppressionsRemoveJobResponseAttributes withTotalCount(long totalCount) {
        Utils.checkNotNull(totalCount, "totalCount");
        this.totalCount = totalCount;
        return this;
    }
     ...
     * The total number of operations that have been completed by the job.
     */
    public PostBulkProfileSuppressionsRemoveJobResponseAttributes withCompletedCount(long completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
     ...
     * The total number of operations that have been completed by the job.
     */
    public PostBulkProfileSuppressionsRemoveJobResponseAttributes withCompletedCount(JsonNullable<Long> completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
        this.completedCount = completedCount;
        return this;
    }
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PostBulkProfileSuppressionsRemoveJobResponseAttributes withCompletedAt(OffsetDateTime completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PostBulkProfileSuppressionsRemoveJobResponseAttributes withCompletedAt(JsonNullable<OffsetDateTime> completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
        this.completedAt = completedAt;
        return this;
    }
     ...
     * The total number of profiles that have been skipped as part of the job.
     */
    public PostBulkProfileSuppressionsRemoveJobResponseAttributes withSkippedCount(long skippedCount) {
        Utils.checkNotNull(skippedCount, "skippedCount");
     ...
     * The total number of profiles that have been skipped as part of the job.
     */
    public PostBulkProfileSuppressionsRemoveJobResponseAttributes withSkippedCount(JsonNullable<Long> skippedCount) {
        Utils.checkNotNull(skippedCount, "skippedCount");
        this.skippedCount = skippedCount;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostBulkProfileSuppressionsRemoveJobResponseAttributes other = (PostBulkProfileSuppressionsRemoveJobResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostBulkProfileSuppressionsRemoveJobResponseAttributes.class,
                "status", status,
                "createdAt", createdAt,
    ...
    public final static class Builder {
         ...
         * Status of the asynchronous job.
         */
        public Builder status(PostBulkProfileSuppressionsRemoveJobResponseStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
        ...
        public PostBulkProfileSuppressionsRemoveJobResponseAttributes build() {
            if (completedCount == null) {
                completedCount = _SINGLETON_VALUE_CompletedCount.value();
            }
            if (skippedCount == null) {
                skippedCount = _SINGLETON_VALUE_SkippedCount.value();
            }            return new PostBulkProfileSuppressionsRemoveJobResponseAttributes(
                status,
                createdAt,
                totalCount,
                completedCount,
