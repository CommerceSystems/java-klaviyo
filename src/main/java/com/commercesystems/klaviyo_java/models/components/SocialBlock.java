...
public class SocialBlock {
    ...
    public SocialBlock(
            ...
            @JsonProperty("type") SocialEnum type,
    ...
    public SocialBlock withContentType(BlockEnum contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }

    public SocialBlock withType(SocialEnum type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public SocialBlock withData(String data) {
        Utils.checkNotNull(data, "data");
        this.data = Optional.ofNullable(data);
        return this;
    }

    public SocialBlock withData(Optional<String> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SocialBlock other = (SocialBlock) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SocialBlock.class,
    ...
    public final static class Builder {
        ...
        public Builder type(SocialEnum type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
