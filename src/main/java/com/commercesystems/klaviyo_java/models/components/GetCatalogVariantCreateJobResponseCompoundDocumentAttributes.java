...
public class GetCatalogVariantCreateJobResponseCompoundDocumentAttributes {

    /**
     * Status of the asynchronous job.
     */
    @JsonProperty("status")
    private GetCatalogVariantCreateJobResponseCompoundDocumentStatus status;
    ...
    @JsonCreator
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes(
            @JsonProperty("status") GetCatalogVariantCreateJobResponseCompoundDocumentStatus status,
    ...
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes(
            GetCatalogVariantCreateJobResponseCompoundDocumentStatus status,
     ...
     */
    @JsonIgnore
    public GetCatalogVariantCreateJobResponseCompoundDocumentStatus status() {
        return status;
    }
     ...
     * Status of the asynchronous job.
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withStatus(GetCatalogVariantCreateJobResponseCompoundDocumentStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The date and time the job was created in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The total number of operations to be processed by the job. See `completed_count` for the job's current progress.
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withTotalCount(long totalCount) {
        Utils.checkNotNull(totalCount, "totalCount");
        this.totalCount = totalCount;
        return this;
    }
     ...
     * The total number of operations that have been completed by the job.
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withCompletedCount(long completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
     ...
     * The total number of operations that have been completed by the job.
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withCompletedCount(JsonNullable<Long> completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
        this.completedCount = completedCount;
        return this;
    }
     ...
     * The total number of operations that have failed as part of the job.
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withFailedCount(long failedCount) {
        Utils.checkNotNull(failedCount, "failedCount");
     ...
     * The total number of operations that have failed as part of the job.
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withFailedCount(JsonNullable<Long> failedCount) {
        Utils.checkNotNull(failedCount, "failedCount");
        this.failedCount = failedCount;
        return this;
    }
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withCompletedAt(OffsetDateTime completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withCompletedAt(JsonNullable<OffsetDateTime> completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
        this.completedAt = completedAt;
        return this;
    }
     ...
     * Array of errors encountered during the processing of the job.
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withErrors(List<APIJobErrorPayload> errors) {
        Utils.checkNotNull(errors, "errors");
     ...
     * Array of errors encountered during the processing of the job.
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withErrors(JsonNullable<? extends List<APIJobErrorPayload>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Date and time the job expires in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withExpiresAt(OffsetDateTime expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
     ...
     * Date and time the job expires in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes withExpiresAt(JsonNullable<OffsetDateTime> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCatalogVariantCreateJobResponseCompoundDocumentAttributes other = (GetCatalogVariantCreateJobResponseCompoundDocumentAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCatalogVariantCreateJobResponseCompoundDocumentAttributes.class,
                "status", status,
                "createdAt", createdAt,
    ...
    public final static class Builder {
         ...
         * Status of the asynchronous job.
         */
        public Builder status(GetCatalogVariantCreateJobResponseCompoundDocumentStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
        ...
        public GetCatalogVariantCreateJobResponseCompoundDocumentAttributes build() {
            if (completedCount == null) {
                completedCount = _SINGLETON_VALUE_CompletedCount.value();
            }
            if (failedCount == null) {
                failedCount = _SINGLETON_VALUE_FailedCount.value();
            }            return new GetCatalogVariantCreateJobResponseCompoundDocumentAttributes(
                status,
                createdAt,
                totalCount,
                completedCount,
