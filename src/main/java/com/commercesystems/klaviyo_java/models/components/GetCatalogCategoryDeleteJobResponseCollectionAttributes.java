...
public class GetCatalogCategoryDeleteJobResponseCollectionAttributes {

    /**
     * Status of the asynchronous job.
     */
    @JsonProperty("status")
    private GetCatalogCategoryDeleteJobResponseCollectionStatus status;
    ...
    @JsonCreator
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes(
            @JsonProperty("status") GetCatalogCategoryDeleteJobResponseCollectionStatus status,
    ...
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes(
            GetCatalogCategoryDeleteJobResponseCollectionStatus status,
     ...
     */
    @JsonIgnore
    public GetCatalogCategoryDeleteJobResponseCollectionStatus status() {
        return status;
    }
     ...
     * Status of the asynchronous job.
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withStatus(GetCatalogCategoryDeleteJobResponseCollectionStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The date and time the job was created in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The total number of operations to be processed by the job. See `completed_count` for the job's current progress.
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withTotalCount(long totalCount) {
        Utils.checkNotNull(totalCount, "totalCount");
        this.totalCount = totalCount;
        return this;
    }
     ...
     * The total number of operations that have been completed by the job.
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withCompletedCount(long completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
     ...
     * The total number of operations that have been completed by the job.
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withCompletedCount(JsonNullable<Long> completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
        this.completedCount = completedCount;
        return this;
    }
     ...
     * The total number of operations that have failed as part of the job.
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withFailedCount(long failedCount) {
        Utils.checkNotNull(failedCount, "failedCount");
     ...
     * The total number of operations that have failed as part of the job.
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withFailedCount(JsonNullable<Long> failedCount) {
        Utils.checkNotNull(failedCount, "failedCount");
        this.failedCount = failedCount;
        return this;
    }
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withCompletedAt(OffsetDateTime completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withCompletedAt(JsonNullable<OffsetDateTime> completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
        this.completedAt = completedAt;
        return this;
    }
     ...
     * Array of errors encountered during the processing of the job.
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withErrors(List<APIJobErrorPayload> errors) {
        Utils.checkNotNull(errors, "errors");
     ...
     * Array of errors encountered during the processing of the job.
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withErrors(JsonNullable<? extends List<APIJobErrorPayload>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Date and time the job expires in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withExpiresAt(OffsetDateTime expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
     ...
     * Date and time the job expires in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryDeleteJobResponseCollectionAttributes withExpiresAt(JsonNullable<OffsetDateTime> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCatalogCategoryDeleteJobResponseCollectionAttributes other = (GetCatalogCategoryDeleteJobResponseCollectionAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCatalogCategoryDeleteJobResponseCollectionAttributes.class,
                "status", status,
                "createdAt", createdAt,
    ...
    public final static class Builder {
         ...
         * Status of the asynchronous job.
         */
        public Builder status(GetCatalogCategoryDeleteJobResponseCollectionStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
        ...
        public GetCatalogCategoryDeleteJobResponseCollectionAttributes build() {
            if (completedCount == null) {
                completedCount = _SINGLETON_VALUE_CompletedCount.value();
            }
            if (failedCount == null) {
                failedCount = _SINGLETON_VALUE_FailedCount.value();
            }            return new GetCatalogCategoryDeleteJobResponseCollectionAttributes(
                status,
                createdAt,
                totalCount,
                completedCount,
