...
/**
 * FlowValuesRequestDTOResourceObjectStatistics - Defined reporting metric
 */
public enum FlowValuesRequestDTOResourceObjectStatistics {
    ...
    private FlowValuesRequestDTOResourceObjectStatistics(String value) {
        this.value = value;
    }
