...
public class PatchCatalogCategoryResponseAttributes {
    ...
    @JsonCreator
    public PatchCatalogCategoryResponseAttributes(
     ...
     * The ID of the catalog category in an external system.
     */
    public PatchCatalogCategoryResponseAttributes withExternalId(String externalId) {
        Utils.checkNotNull(externalId, "externalId");
     ...
     * The ID of the catalog category in an external system.
     */
    public PatchCatalogCategoryResponseAttributes withExternalId(JsonNullable<String> externalId) {
        Utils.checkNotNull(externalId, "externalId");
        this.externalId = externalId;
        return this;
    }
     ...
     * The name of the catalog category.
     */
    public PatchCatalogCategoryResponseAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the catalog category.
     */
    public PatchCatalogCategoryResponseAttributes withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * Date and time when the catalog category was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PatchCatalogCategoryResponseAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
     ...
     * Date and time when the catalog category was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PatchCatalogCategoryResponseAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchCatalogCategoryResponseAttributes other = (PatchCatalogCategoryResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchCatalogCategoryResponseAttributes.class,
    ...
    public final static class Builder {
        ...
        public PatchCatalogCategoryResponseAttributes build() {
            return new PatchCatalogCategoryResponseAttributes(
                externalId,
                name,
                updated);
        }
