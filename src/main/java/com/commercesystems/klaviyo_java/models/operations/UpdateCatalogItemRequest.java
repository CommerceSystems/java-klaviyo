...
public class UpdateCatalogItemRequest {
    ...
    @JsonIgnore
    public CatalogItemUpdateQuery catalogItemUpdateQuery() {
     ...
     * The catalog item ID is a compound ID (string), with format: `{integration}:::{catalog}:::{external_id}`. Currently, the only supported integration type is `$custom`, and the only supported catalog is `$default`.
     */
    public UpdateCatalogItemRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public UpdateCatalogItemRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }

    public UpdateCatalogItemRequest withCatalogItemUpdateQuery(CatalogItemUpdateQuery catalogItemUpdateQuery) {
        Utils.checkNotNull(catalogItemUpdateQuery, "catalogItemUpdateQuery");
        this.catalogItemUpdateQuery = catalogItemUpdateQuery;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateCatalogItemRequest other = (UpdateCatalogItemRequest) o;
        return 
            Objects.deepEquals(this.id, other.id) &&
            Objects.deepEquals(this.revision, other.revision) &&
            Objects.deepEquals(this.catalogItemUpdateQuery, other.catalogItemUpdateQuery);
    }
    ...
    public String toString() {
        return Utils.toString(UpdateCatalogItemRequest.class,
                "id", id,
                "revision", revision,
                "catalogItemUpdateQuery", catalogItemUpdateQuery);
    }
    ...
    public final static class Builder {
        ...
        public Builder catalogItemUpdateQuery(CatalogItemUpdateQuery catalogItemUpdateQuery) {
            Utils.checkNotNull(catalogItemUpdateQuery, "catalogItemUpdateQuery");
            this.catalogItemUpdateQuery = catalogItemUpdateQuery;
            return this;
        }
