...
public class GetBulkProfileSuppressionsRemoveJobResponseAttributes {

    /**
     * Status of the asynchronous job.
     */
    @JsonProperty("status")
    private GetBulkProfileSuppressionsRemoveJobResponseStatus status;
    ...
    @JsonCreator
    public GetBulkProfileSuppressionsRemoveJobResponseAttributes(
            @JsonProperty("status") GetBulkProfileSuppressionsRemoveJobResponseStatus status,
    ...
    public GetBulkProfileSuppressionsRemoveJobResponseAttributes(
            GetBulkProfileSuppressionsRemoveJobResponseStatus status,
     ...
     */
    @JsonIgnore
    public GetBulkProfileSuppressionsRemoveJobResponseStatus status() {
        return status;
    }
     ...
     * Status of the asynchronous job.
     */
    public GetBulkProfileSuppressionsRemoveJobResponseAttributes withStatus(GetBulkProfileSuppressionsRemoveJobResponseStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The date and time the job was created in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetBulkProfileSuppressionsRemoveJobResponseAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The total number of operations to be processed by the job. See `completed_count` for the job's current progress.
     */
    public GetBulkProfileSuppressionsRemoveJobResponseAttributes withTotalCount(long totalCount) {
        Utils.checkNotNull(totalCount, "totalCount");
        this.totalCount = totalCount;
        return this;
    }
     ...
     * The total number of operations that have been completed by the job.
     */
    public GetBulkProfileSuppressionsRemoveJobResponseAttributes withCompletedCount(long completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
     ...
     * The total number of operations that have been completed by the job.
     */
    public GetBulkProfileSuppressionsRemoveJobResponseAttributes withCompletedCount(JsonNullable<Long> completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
        this.completedCount = completedCount;
        return this;
    }
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetBulkProfileSuppressionsRemoveJobResponseAttributes withCompletedAt(OffsetDateTime completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetBulkProfileSuppressionsRemoveJobResponseAttributes withCompletedAt(JsonNullable<OffsetDateTime> completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
        this.completedAt = completedAt;
        return this;
    }
     ...
     * The total number of profiles that have been skipped as part of the job.
     */
    public GetBulkProfileSuppressionsRemoveJobResponseAttributes withSkippedCount(long skippedCount) {
        Utils.checkNotNull(skippedCount, "skippedCount");
     ...
     * The total number of profiles that have been skipped as part of the job.
     */
    public GetBulkProfileSuppressionsRemoveJobResponseAttributes withSkippedCount(JsonNullable<Long> skippedCount) {
        Utils.checkNotNull(skippedCount, "skippedCount");
        this.skippedCount = skippedCount;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetBulkProfileSuppressionsRemoveJobResponseAttributes other = (GetBulkProfileSuppressionsRemoveJobResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetBulkProfileSuppressionsRemoveJobResponseAttributes.class,
                "status", status,
                "createdAt", createdAt,
    ...
    public final static class Builder {
         ...
         * Status of the asynchronous job.
         */
        public Builder status(GetBulkProfileSuppressionsRemoveJobResponseStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
        ...
        public GetBulkProfileSuppressionsRemoveJobResponseAttributes build() {
            if (completedCount == null) {
                completedCount = _SINGLETON_VALUE_CompletedCount.value();
            }
            if (skippedCount == null) {
                skippedCount = _SINGLETON_VALUE_SkippedCount.value();
            }            return new GetBulkProfileSuppressionsRemoveJobResponseAttributes(
                status,
                createdAt,
                totalCount,
                completedCount,
