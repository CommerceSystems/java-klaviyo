...
public class DeleteCouponCodeRequest {
     ...
     * The id of a coupon code is a combination of its unique code and the id of the coupon it is associated with.
     */
    public DeleteCouponCodeRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public DeleteCouponCodeRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteCouponCodeRequest other = (DeleteCouponCodeRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteCouponCodeRequest.class,
                "id", id,
                "revision", revision);
    }
    ...
    public final static class Builder {
        ...
        public DeleteCouponCodeRequest build() {
            if (revision == null) {
                revision = _SINGLETON_VALUE_Revision.value();
            }            return new DeleteCouponCodeRequest(
                id,
                revision);
        }
