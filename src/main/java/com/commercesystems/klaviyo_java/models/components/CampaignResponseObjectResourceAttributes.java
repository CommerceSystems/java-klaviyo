...
public class CampaignResponseObjectResourceAttributes {
    ...
    private CampaignResponseObjectResourceSendOptions sendOptions;

    /**
     * The tracking options associated with the campaign
     */
    @JsonProperty("tracking_options")
    private CampaignResponseObjectResourceTrackingOptions trackingOptions;
    ...
    @JsonCreator
    public CampaignResponseObjectResourceAttributes(
            @JsonProperty("name") String name,
            @JsonProperty("status") String status,
            @JsonProperty("archived") boolean archived,
            @JsonProperty("audiences") AudiencesSubObject audiences,
            @JsonProperty("send_options") CampaignResponseObjectResourceSendOptions sendOptions,
            @JsonProperty("tracking_options") CampaignResponseObjectResourceTrackingOptions trackingOptions,
    ...
    public CampaignResponseObjectResourceAttributes(
            ...
            CampaignResponseObjectResourceSendOptions sendOptions,
            CampaignResponseObjectResourceTrackingOptions trackingOptions,
     ...
     */
    @JsonIgnore
    public CampaignResponseObjectResourceSendOptions sendOptions() {
        return sendOptions;
    }
     ...
     */
    @JsonIgnore
    public CampaignResponseObjectResourceTrackingOptions trackingOptions() {
     ...
     * The campaign name
     */
    public CampaignResponseObjectResourceAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The current status of the campaign
     */
    public CampaignResponseObjectResourceAttributes withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Whether the campaign has been archived or not
     */
    public CampaignResponseObjectResourceAttributes withArchived(boolean archived) {
        Utils.checkNotNull(archived, "archived");
        this.archived = archived;
        return this;
    }

    public CampaignResponseObjectResourceAttributes withAudiences(AudiencesSubObject audiences) {
        Utils.checkNotNull(audiences, "audiences");
        this.audiences = audiences;
        return this;
    }
     ...
     * Options to use when sending a campaign
     */
    public CampaignResponseObjectResourceAttributes withSendOptions(CampaignResponseObjectResourceSendOptions sendOptions) {
        Utils.checkNotNull(sendOptions, "sendOptions");
        this.sendOptions = sendOptions;
        return this;
    }
     ...
     * The tracking options associated with the campaign
     */
    public CampaignResponseObjectResourceAttributes withTrackingOptions(CampaignResponseObjectResourceTrackingOptions trackingOptions) {
        Utils.checkNotNull(trackingOptions, "trackingOptions");
        this.trackingOptions = trackingOptions;
        return this;
    }

    public CampaignResponseObjectResourceAttributes withSendStrategy(SendStrategySubObject sendStrategy) {
        Utils.checkNotNull(sendStrategy, "sendStrategy");
        this.sendStrategy = sendStrategy;
        return this;
    }
     ...
     * The datetime when the campaign was created
     */
    public CampaignResponseObjectResourceAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The datetime when the campaign was scheduled for future sending
     */
    public CampaignResponseObjectResourceAttributes withScheduledAt(OffsetDateTime scheduledAt) {
        Utils.checkNotNull(scheduledAt, "scheduledAt");
     ...
     * The datetime when the campaign was scheduled for future sending
     */
    public CampaignResponseObjectResourceAttributes withScheduledAt(JsonNullable<OffsetDateTime> scheduledAt) {
        Utils.checkNotNull(scheduledAt, "scheduledAt");
        this.scheduledAt = scheduledAt;
        return this;
    }
     ...
     * The datetime when the campaign was last updated by a user or the system
     */
    public CampaignResponseObjectResourceAttributes withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * The datetime when the campaign will be / was sent or None if not yet scheduled by a send_job.
     */
    public CampaignResponseObjectResourceAttributes withSendTime(OffsetDateTime sendTime) {
        Utils.checkNotNull(sendTime, "sendTime");
     ...
     * The datetime when the campaign will be / was sent or None if not yet scheduled by a send_job.
     */
    public CampaignResponseObjectResourceAttributes withSendTime(JsonNullable<OffsetDateTime> sendTime) {
        Utils.checkNotNull(sendTime, "sendTime");
        this.sendTime = sendTime;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CampaignResponseObjectResourceAttributes other = (CampaignResponseObjectResourceAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CampaignResponseObjectResourceAttributes.class,
                "name", name,
                "status", status,
                "archived", archived,
                "audiences", audiences,
    ...
    public final static class Builder {
         ...
         * Options to use when sending a campaign
         */
        public Builder sendOptions(CampaignResponseObjectResourceSendOptions sendOptions) {
            Utils.checkNotNull(sendOptions, "sendOptions");
            this.sendOptions = sendOptions;
            return this;
        }
         ...
         * The tracking options associated with the campaign
         */
        public Builder trackingOptions(CampaignResponseObjectResourceTrackingOptions trackingOptions) {
            Utils.checkNotNull(trackingOptions, "trackingOptions");
            this.trackingOptions = trackingOptions;
            return this;
        }
        ...
        public CampaignResponseObjectResourceAttributes build() {
            return new CampaignResponseObjectResourceAttributes(
                name,
                status,
                archived,
                audiences,
