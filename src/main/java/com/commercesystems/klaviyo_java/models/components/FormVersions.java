...
public class FormVersions {
    ...
    public FormVersions withLinks(RelationshipLinks links) {
        Utils.checkNotNull(links, "links");
        this.links = Optional.ofNullable(links);
        return this;
    }

    public FormVersions withLinks(Optional<? extends RelationshipLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FormVersions other = (FormVersions) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FormVersions.class,
                "links", links);
    }
    ...
    public final static class Builder {
        ...
        public FormVersions build() {
            return new FormVersions(
                links);
        }
    }
}
