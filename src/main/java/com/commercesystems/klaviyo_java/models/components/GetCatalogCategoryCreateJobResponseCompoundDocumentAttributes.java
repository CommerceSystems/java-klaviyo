...
public class GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes {

    /**
     * Status of the asynchronous job.
     */
    @JsonProperty("status")
    private GetCatalogCategoryCreateJobResponseCompoundDocumentStatus status;
    ...
    @JsonCreator
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes(
            @JsonProperty("status") GetCatalogCategoryCreateJobResponseCompoundDocumentStatus status,
    ...
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes(
            GetCatalogCategoryCreateJobResponseCompoundDocumentStatus status,
     ...
     */
    @JsonIgnore
    public GetCatalogCategoryCreateJobResponseCompoundDocumentStatus status() {
        return status;
    }
     ...
     * Status of the asynchronous job.
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withStatus(GetCatalogCategoryCreateJobResponseCompoundDocumentStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The date and time the job was created in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The total number of operations to be processed by the job. See `completed_count` for the job's current progress.
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withTotalCount(long totalCount) {
        Utils.checkNotNull(totalCount, "totalCount");
        this.totalCount = totalCount;
        return this;
    }
     ...
     * The total number of operations that have been completed by the job.
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withCompletedCount(long completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
     ...
     * The total number of operations that have been completed by the job.
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withCompletedCount(JsonNullable<Long> completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
        this.completedCount = completedCount;
        return this;
    }
     ...
     * The total number of operations that have failed as part of the job.
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withFailedCount(long failedCount) {
        Utils.checkNotNull(failedCount, "failedCount");
     ...
     * The total number of operations that have failed as part of the job.
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withFailedCount(JsonNullable<Long> failedCount) {
        Utils.checkNotNull(failedCount, "failedCount");
        this.failedCount = failedCount;
        return this;
    }
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withCompletedAt(OffsetDateTime completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withCompletedAt(JsonNullable<OffsetDateTime> completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
        this.completedAt = completedAt;
        return this;
    }
     ...
     * Array of errors encountered during the processing of the job.
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withErrors(List<APIJobErrorPayload> errors) {
        Utils.checkNotNull(errors, "errors");
     ...
     * Array of errors encountered during the processing of the job.
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withErrors(JsonNullable<? extends List<APIJobErrorPayload>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Date and time the job expires in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withExpiresAt(OffsetDateTime expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
     ...
     * Date and time the job expires in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes withExpiresAt(JsonNullable<OffsetDateTime> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes other = (GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes.class,
                "status", status,
                "createdAt", createdAt,
    ...
    public final static class Builder {
         ...
         * Status of the asynchronous job.
         */
        public Builder status(GetCatalogCategoryCreateJobResponseCompoundDocumentStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
        ...
        public GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes build() {
            if (completedCount == null) {
                completedCount = _SINGLETON_VALUE_CompletedCount.value();
            }
            if (failedCount == null) {
                failedCount = _SINGLETON_VALUE_FailedCount.value();
            }            return new GetCatalogCategoryCreateJobResponseCompoundDocumentAttributes(
                status,
                createdAt,
                totalCount,
                completedCount,
