...
public class NoSMSMarketing {
    ...
    public NoSMSMarketing withSubscription(AnyEnum subscription) {
        Utils.checkNotNull(subscription, "subscription");
        this.subscription = subscription;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        NoSMSMarketing other = (NoSMSMarketing) o;
        return 
    ...
    public String toString() {
        return Utils.toString(NoSMSMarketing.class,
    ...
    public final static class Builder {
        ...
        public NoSMSMarketing build() {
            return new NoSMSMarketing(
                subscription);
        }
    }
}
