...
public class GetUpdateCategoriesJobsRequest {
    ...
    private Optional<? extends List<FieldsCatalogCategoryBulkUpdateJob>> fieldsCatalogCategoryBulkUpdateJob;
    ...
    @JsonCreator
    public GetUpdateCategoriesJobsRequest(
    ...
    @JsonIgnore
    public Optional<List<FieldsCatalogCategoryBulkUpdateJob>> fieldsCatalogCategoryBulkUpdateJob() {
        return (Optional<List<FieldsCatalogCategoryBulkUpdateJob>>) fieldsCatalogCategoryBulkUpdateJob;
    }
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
     */
    public GetUpdateCategoriesJobsRequest withFieldsCatalogCategoryBulkUpdateJob(List<FieldsCatalogCategoryBulkUpdateJob> fieldsCatalogCategoryBulkUpdateJob) {
        Utils.checkNotNull(fieldsCatalogCategoryBulkUpdateJob, "fieldsCatalogCategoryBulkUpdateJob");
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
     */
    public GetUpdateCategoriesJobsRequest withFieldsCatalogCategoryBulkUpdateJob(Optional<? extends List<FieldsCatalogCategoryBulkUpdateJob>> fieldsCatalogCategoryBulkUpdateJob) {
        Utils.checkNotNull(fieldsCatalogCategoryBulkUpdateJob, "fieldsCatalogCategoryBulkUpdateJob");
        this.fieldsCatalogCategoryBulkUpdateJob = fieldsCatalogCategoryBulkUpdateJob;
        return this;
    }
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;`status`: `equals`
     */
    public GetUpdateCategoriesJobsRequest withFilter(String filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;`status`: `equals`
     */
    public GetUpdateCategoriesJobsRequest withFilter(Optional<String> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#pagination
     */
    public GetUpdateCategoriesJobsRequest withPageCursor(String pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#pagination
     */
    public GetUpdateCategoriesJobsRequest withPageCursor(Optional<String> pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
        this.pageCursor = pageCursor;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public GetUpdateCategoriesJobsRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetUpdateCategoriesJobsRequest other = (GetUpdateCategoriesJobsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetUpdateCategoriesJobsRequest.class,
    ...
    public final static class Builder {
         ...
         * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
         */
        public Builder fieldsCatalogCategoryBulkUpdateJob(List<FieldsCatalogCategoryBulkUpdateJob> fieldsCatalogCategoryBulkUpdateJob) {
            Utils.checkNotNull(fieldsCatalogCategoryBulkUpdateJob, "fieldsCatalogCategoryBulkUpdateJob");
            this.fieldsCatalogCategoryBulkUpdateJob = Optional.ofNullable(fieldsCatalogCategoryBulkUpdateJob);
            return this;
        }
         ...
         * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
         */
        public Builder fieldsCatalogCategoryBulkUpdateJob(Optional<? extends List<FieldsCatalogCategoryBulkUpdateJob>> fieldsCatalogCategoryBulkUpdateJob) {
            Utils.checkNotNull(fieldsCatalogCategoryBulkUpdateJob, "fieldsCatalogCategoryBulkUpdateJob");
            this.fieldsCatalogCategoryBulkUpdateJob = fieldsCatalogCategoryBulkUpdateJob;
            return this;
        }
        ...
        public GetUpdateCategoriesJobsRequest build() {
            if (revision == null) {
                revision = _SINGLETON_VALUE_Revision.value();
            }            return new GetUpdateCategoriesJobsRequest(
                fieldsCatalogCategoryBulkUpdateJob,
                filter,
                pageCursor,
                revision);
