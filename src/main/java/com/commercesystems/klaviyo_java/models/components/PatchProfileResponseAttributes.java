...
public class PatchProfileResponseAttributes {
    ...
    private JsonNullable<? extends PatchProfileResponseProperties> properties;
    ...
    @JsonCreator
    public PatchProfileResponseAttributes(
            ...
            @JsonProperty("properties") JsonNullable<? extends PatchProfileResponseProperties> properties,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<PatchProfileResponseProperties> properties() {
        return (JsonNullable<PatchProfileResponseProperties>) properties;
    }
     ...
     * Individual's email address
     */
    public PatchProfileResponseAttributes withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * Individual's email address
     */
    public PatchProfileResponseAttributes withEmail(JsonNullable<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * Individual's phone number in E.164 format
     */
    public PatchProfileResponseAttributes withPhoneNumber(String phoneNumber) {
        Utils.checkNotNull(phoneNumber, "phoneNumber");
     ...
     * Individual's phone number in E.164 format
     */
    public PatchProfileResponseAttributes withPhoneNumber(JsonNullable<String> phoneNumber) {
        Utils.checkNotNull(phoneNumber, "phoneNumber");
        this.phoneNumber = phoneNumber;
        return this;
    }
     ...
     * A unique identifier used by customers to associate Klaviyo profiles with profiles in an external system, such as a point-of-sale system. Format varies based on the external system.
     */
    public PatchProfileResponseAttributes withExternalId(String externalId) {
        Utils.checkNotNull(externalId, "externalId");
     ...
     * A unique identifier used by customers to associate Klaviyo profiles with profiles in an external system, such as a point-of-sale system. Format varies based on the external system.
     */
    public PatchProfileResponseAttributes withExternalId(JsonNullable<String> externalId) {
        Utils.checkNotNull(externalId, "externalId");
        this.externalId = externalId;
        return this;
    }
     ...
     * Individual's first name
     */
    public PatchProfileResponseAttributes withFirstName(String firstName) {
        Utils.checkNotNull(firstName, "firstName");
     ...
     * Individual's first name
     */
    public PatchProfileResponseAttributes withFirstName(JsonNullable<String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * Individual's last name
     */
    public PatchProfileResponseAttributes withLastName(String lastName) {
        Utils.checkNotNull(lastName, "lastName");
     ...
     * Individual's last name
     */
    public PatchProfileResponseAttributes withLastName(JsonNullable<String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
     ...
     * Name of the company or organization within the company for whom the individual works
     */
    public PatchProfileResponseAttributes withOrganization(String organization) {
        Utils.checkNotNull(organization, "organization");
     ...
     * Name of the company or organization within the company for whom the individual works
     */
    public PatchProfileResponseAttributes withOrganization(JsonNullable<String> organization) {
        Utils.checkNotNull(organization, "organization");
        this.organization = organization;
        return this;
    }
     ...
     * The locale of the profile, in the IETF BCP 47 language tag format like (ISO 639-1/2)-(ISO 3166 alpha-2)
     */
    public PatchProfileResponseAttributes withLocale(String locale) {
        Utils.checkNotNull(locale, "locale");
     ...
     * The locale of the profile, in the IETF BCP 47 language tag format like (ISO 639-1/2)-(ISO 3166 alpha-2)
     */
    public PatchProfileResponseAttributes withLocale(JsonNullable<String> locale) {
        Utils.checkNotNull(locale, "locale");
        this.locale = locale;
        return this;
    }
     ...
     * Individual's job title
     */
    public PatchProfileResponseAttributes withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * Individual's job title
     */
    public PatchProfileResponseAttributes withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * URL pointing to the location of a profile image
     */
    public PatchProfileResponseAttributes withImage(String image) {
        Utils.checkNotNull(image, "image");
     ...
     * URL pointing to the location of a profile image
     */
    public PatchProfileResponseAttributes withImage(JsonNullable<String> image) {
        Utils.checkNotNull(image, "image");
        this.image = image;
        return this;
    }
     ...
     * Date and time when the profile was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PatchProfileResponseAttributes withCreated(OffsetDateTime created) {
        Utils.checkNotNull(created, "created");
     ...
     * Date and time when the profile was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PatchProfileResponseAttributes withCreated(JsonNullable<OffsetDateTime> created) {
        Utils.checkNotNull(created, "created");
        this.created = created;
        return this;
    }
     ...
     * Date and time when the profile was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PatchProfileResponseAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
     ...
     * Date and time when the profile was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PatchProfileResponseAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }
     ...
     * Date and time of the most recent event the triggered an update to the profile, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PatchProfileResponseAttributes withLastEventDate(OffsetDateTime lastEventDate) {
        Utils.checkNotNull(lastEventDate, "lastEventDate");
     ...
     * Date and time of the most recent event the triggered an update to the profile, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PatchProfileResponseAttributes withLastEventDate(JsonNullable<OffsetDateTime> lastEventDate) {
        Utils.checkNotNull(lastEventDate, "lastEventDate");
        this.lastEventDate = lastEventDate;
        return this;
    }

    public PatchProfileResponseAttributes withLocation(ProfileLocation location) {
        Utils.checkNotNull(location, "location");
        this.location = Optional.ofNullable(location);
        return this;
    }

    public PatchProfileResponseAttributes withLocation(Optional<? extends ProfileLocation> location) {
        Utils.checkNotNull(location, "location");
        this.location = location;
        return this;
    }
     ...
     * An object containing key/value pairs for any custom properties assigned to this profile
     */
    public PatchProfileResponseAttributes withProperties(PatchProfileResponseProperties properties) {
        Utils.checkNotNull(properties, "properties");
     ...
     * An object containing key/value pairs for any custom properties assigned to this profile
     */
    public PatchProfileResponseAttributes withProperties(JsonNullable<? extends PatchProfileResponseProperties> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = properties;
        return this;
    }

    public PatchProfileResponseAttributes withSubscriptions(Subscriptions subscriptions) {
        Utils.checkNotNull(subscriptions, "subscriptions");
        this.subscriptions = Optional.ofNullable(subscriptions);
        return this;
    }

    public PatchProfileResponseAttributes withSubscriptions(Optional<? extends Subscriptions> subscriptions) {
        Utils.checkNotNull(subscriptions, "subscriptions");
        this.subscriptions = subscriptions;
        return this;
    }

    public PatchProfileResponseAttributes withPredictiveAnalytics(PredictiveAnalytics predictiveAnalytics) {
        Utils.checkNotNull(predictiveAnalytics, "predictiveAnalytics");
        this.predictiveAnalytics = Optional.ofNullable(predictiveAnalytics);
        return this;
    }

    public PatchProfileResponseAttributes withPredictiveAnalytics(Optional<? extends PredictiveAnalytics> predictiveAnalytics) {
        Utils.checkNotNull(predictiveAnalytics, "predictiveAnalytics");
        this.predictiveAnalytics = predictiveAnalytics;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchProfileResponseAttributes other = (PatchProfileResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchProfileResponseAttributes.class,
                "email", email,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends PatchProfileResponseProperties> properties = JsonNullable.undefined();
         ...
         * An object containing key/value pairs for any custom properties assigned to this profile
         */
        public Builder properties(PatchProfileResponseProperties properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = JsonNullable.of(properties);
            return this;
        }
         ...
         * An object containing key/value pairs for any custom properties assigned to this profile
         */
        public Builder properties(JsonNullable<? extends PatchProfileResponseProperties> properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = properties;
            return this;
        }
        ...
        public PatchProfileResponseAttributes build() {
            return new PatchProfileResponseAttributes(
                email,
                phoneNumber,
                externalId,
                firstName,
