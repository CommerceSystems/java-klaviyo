...
public class ProfileResponseObjectResourceAttributes {
    ...
    private JsonNullable<? extends Properties> properties;

    @JsonCreator
    public ProfileResponseObjectResourceAttributes(
            ...
            @JsonProperty("properties") JsonNullable<? extends Properties> properties) {
    ...
    public ProfileResponseObjectResourceAttributes() {
        this(JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), Optional.empty(), JsonNullable.undefined());
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<Properties> properties() {
        return (JsonNullable<Properties>) properties;
    }
     ...
     * Individual's email address
     */
    public ProfileResponseObjectResourceAttributes withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * Individual's email address
     */
    public ProfileResponseObjectResourceAttributes withEmail(JsonNullable<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * Individual's phone number in E.164 format
     */
    public ProfileResponseObjectResourceAttributes withPhoneNumber(String phoneNumber) {
        Utils.checkNotNull(phoneNumber, "phoneNumber");
     ...
     * Individual's phone number in E.164 format
     */
    public ProfileResponseObjectResourceAttributes withPhoneNumber(JsonNullable<String> phoneNumber) {
        Utils.checkNotNull(phoneNumber, "phoneNumber");
        this.phoneNumber = phoneNumber;
        return this;
    }
     ...
     * A unique identifier used by customers to associate Klaviyo profiles with profiles in an external system, such as a point-of-sale system. Format varies based on the external system.
     */
    public ProfileResponseObjectResourceAttributes withExternalId(String externalId) {
        Utils.checkNotNull(externalId, "externalId");
     ...
     * A unique identifier used by customers to associate Klaviyo profiles with profiles in an external system, such as a point-of-sale system. Format varies based on the external system.
     */
    public ProfileResponseObjectResourceAttributes withExternalId(JsonNullable<String> externalId) {
        Utils.checkNotNull(externalId, "externalId");
        this.externalId = externalId;
        return this;
    }
     ...
     * Individual's first name
     */
    public ProfileResponseObjectResourceAttributes withFirstName(String firstName) {
        Utils.checkNotNull(firstName, "firstName");
     ...
     * Individual's first name
     */
    public ProfileResponseObjectResourceAttributes withFirstName(JsonNullable<String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * Individual's last name
     */
    public ProfileResponseObjectResourceAttributes withLastName(String lastName) {
        Utils.checkNotNull(lastName, "lastName");
     ...
     * Individual's last name
     */
    public ProfileResponseObjectResourceAttributes withLastName(JsonNullable<String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
     ...
     * Name of the company or organization within the company for whom the individual works
     */
    public ProfileResponseObjectResourceAttributes withOrganization(String organization) {
        Utils.checkNotNull(organization, "organization");
     ...
     * Name of the company or organization within the company for whom the individual works
     */
    public ProfileResponseObjectResourceAttributes withOrganization(JsonNullable<String> organization) {
        Utils.checkNotNull(organization, "organization");
        this.organization = organization;
        return this;
    }
     ...
     * The locale of the profile, in the IETF BCP 47 language tag format like (ISO 639-1/2)-(ISO 3166 alpha-2)
     */
    public ProfileResponseObjectResourceAttributes withLocale(String locale) {
        Utils.checkNotNull(locale, "locale");
     ...
     * The locale of the profile, in the IETF BCP 47 language tag format like (ISO 639-1/2)-(ISO 3166 alpha-2)
     */
    public ProfileResponseObjectResourceAttributes withLocale(JsonNullable<String> locale) {
        Utils.checkNotNull(locale, "locale");
        this.locale = locale;
        return this;
    }
     ...
     * Individual's job title
     */
    public ProfileResponseObjectResourceAttributes withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * Individual's job title
     */
    public ProfileResponseObjectResourceAttributes withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * URL pointing to the location of a profile image
     */
    public ProfileResponseObjectResourceAttributes withImage(String image) {
        Utils.checkNotNull(image, "image");
     ...
     * URL pointing to the location of a profile image
     */
    public ProfileResponseObjectResourceAttributes withImage(JsonNullable<String> image) {
        Utils.checkNotNull(image, "image");
        this.image = image;
        return this;
    }
     ...
     * Date and time when the profile was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public ProfileResponseObjectResourceAttributes withCreated(OffsetDateTime created) {
        Utils.checkNotNull(created, "created");
     ...
     * Date and time when the profile was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public ProfileResponseObjectResourceAttributes withCreated(JsonNullable<OffsetDateTime> created) {
        Utils.checkNotNull(created, "created");
        this.created = created;
        return this;
    }
     ...
     * Date and time when the profile was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public ProfileResponseObjectResourceAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
     ...
     * Date and time when the profile was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public ProfileResponseObjectResourceAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }
     ...
     * Date and time of the most recent event the triggered an update to the profile, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public ProfileResponseObjectResourceAttributes withLastEventDate(OffsetDateTime lastEventDate) {
        Utils.checkNotNull(lastEventDate, "lastEventDate");
     ...
     * Date and time of the most recent event the triggered an update to the profile, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public ProfileResponseObjectResourceAttributes withLastEventDate(JsonNullable<OffsetDateTime> lastEventDate) {
        Utils.checkNotNull(lastEventDate, "lastEventDate");
        this.lastEventDate = lastEventDate;
        return this;
    }

    public ProfileResponseObjectResourceAttributes withLocation(ProfileLocation location) {
        Utils.checkNotNull(location, "location");
        this.location = Optional.ofNullable(location);
        return this;
    }

    public ProfileResponseObjectResourceAttributes withLocation(Optional<? extends ProfileLocation> location) {
        Utils.checkNotNull(location, "location");
        this.location = location;
        return this;
    }
     ...
     * An object containing key/value pairs for any custom properties assigned to this profile
     */
    public ProfileResponseObjectResourceAttributes withProperties(Properties properties) {
        Utils.checkNotNull(properties, "properties");
     ...
     * An object containing key/value pairs for any custom properties assigned to this profile
     */
    public ProfileResponseObjectResourceAttributes withProperties(JsonNullable<? extends Properties> properties) {
        Utils.checkNotNull(properties, "properties");
        this.properties = properties;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ProfileResponseObjectResourceAttributes other = (ProfileResponseObjectResourceAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ProfileResponseObjectResourceAttributes.class,
                "email", email,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends Properties> properties = JsonNullable.undefined();  
         ...
         * An object containing key/value pairs for any custom properties assigned to this profile
         */
        public Builder properties(JsonNullable<? extends Properties> properties) {
            Utils.checkNotNull(properties, "properties");
            this.properties = properties;
            return this;
        }
        
        public ProfileResponseObjectResourceAttributes build() {
            return new ProfileResponseObjectResourceAttributes(
                email,
                phoneNumber,
                externalId,
                firstName,
