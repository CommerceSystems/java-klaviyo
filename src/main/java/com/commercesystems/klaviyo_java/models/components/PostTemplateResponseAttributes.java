...
public class PostTemplateResponseAttributes {
    ...
    @JsonCreator
    public PostTemplateResponseAttributes(
     ...
     * The name of the template
     */
    public PostTemplateResponseAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * * USER_DRAGGABLE: A hybrid template, using custom HTML in the drag-and-drop editor
     */
    public PostTemplateResponseAttributes withEditorType(String editorType) {
        Utils.checkNotNull(editorType, "editorType");
        this.editorType = editorType;
        return this;
    }
     ...
     * The rendered HTML of the template
     */
    public PostTemplateResponseAttributes withHtml(String html) {
        Utils.checkNotNull(html, "html");
        this.html = html;
        return this;
    }
     ...
     * The template plain_text
     */
    public PostTemplateResponseAttributes withText(String text) {
        Utils.checkNotNull(text, "text");
     ...
     * The template plain_text
     */
    public PostTemplateResponseAttributes withText(JsonNullable<String> text) {
        Utils.checkNotNull(text, "text");
        this.text = text;
        return this;
    }
     ...
     * The date the template was created in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PostTemplateResponseAttributes withCreated(OffsetDateTime created) {
        Utils.checkNotNull(created, "created");
     ...
     * The date the template was created in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PostTemplateResponseAttributes withCreated(JsonNullable<OffsetDateTime> created) {
        Utils.checkNotNull(created, "created");
        this.created = created;
        return this;
    }
     ...
     * The date the template was updated in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PostTemplateResponseAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
     ...
     * The date the template was updated in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PostTemplateResponseAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostTemplateResponseAttributes other = (PostTemplateResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostTemplateResponseAttributes.class,
                "name", name,
    ...
    public final static class Builder {
        ...
        public PostTemplateResponseAttributes build() {
            return new PostTemplateResponseAttributes(
                name,
                editorType,
                html,
                text,
