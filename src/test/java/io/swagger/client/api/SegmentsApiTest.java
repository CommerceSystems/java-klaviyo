...
public class SegmentsApiTest {
     ...
     */
    @Test
    public void getProfileIdsForSegmentTest() throws Exception {
        String id = null;
        String revision = null;
        String filter = null;
        ...
        String sort = null;
        GetSegmentRelationshipsResponseCollection response = api.getProfileIdsForSegment(id, revision, filter, pageCursor, pageSize, sort);
     ...
     */
    @Test
    public void getProfilesForSegmentTest() throws Exception {
        String id = null;
        String revision = null;
        ...
        Integer pageSize = null;
        String sort = null;
        GetSegmentMemberResponseCollection response = api.getProfilesForSegment(id, revision, additionalFieldsProfile, fieldsProfile, filter, pageCursor, pageSize, sort);
    ...
    public void getSegmentTest() throws Exception {
        ...
        GetSegmentRetrieveResponseCompoundDocument response = api.getSegment(id, revision, additionalFieldsSegment, fieldsFlow, fieldsSegment, fieldsTag, include);
     ...
     */
    @Test
    public void getSegmentFlowTriggersTest() throws Exception {
        String id = null;
        String revision = null;
        List<String> fieldsFlow = null;
        GetFlowResponseCollection response = api.getSegmentFlowTriggers(id, revision, fieldsFlow);
     ...
     */
    @Test
    public void getSegmentRelationshipsFlowTriggersTest() throws Exception {
        String id = null;
        String revision = null;
        GetSegmentFlowTriggersRelationshipResponseCollection response = api.getSegmentRelationshipsFlowTriggers(id, revision);
    ...
    public void getSegmentsTest() throws Exception {
        ...
        String pageCursor = null;
        String sort = null;
        GetSegmentListResponseCollectionCompoundDocument response = api.getSegments(revision, fieldsFlow, fieldsSegment, fieldsTag, filter, include, pageCursor, sort);
     ...
     */
    @Test
    public void getTagIdsForSegmentTest() throws Exception {
        String id = null;
        String revision = null;
        GetSegmentTagRelationshipListResponseCollection response = api.getTagIdsForSegment(id, revision);
     ...
     */
    @Test
    public void getTagsForSegmentTest() throws Exception {
        String id = null;
        String revision = null;
        List<String> fieldsTag = null;
        GetTagResponseCollection response = api.getTagsForSegment(id, revision, fieldsTag);
