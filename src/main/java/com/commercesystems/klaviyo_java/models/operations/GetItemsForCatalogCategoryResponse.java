...
public class GetItemsForCatalogCategoryResponse implements Response {
    ...
    @JsonCreator
    public GetItemsForCatalogCategoryResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetItemsForCatalogCategoryResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetItemsForCatalogCategoryResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetItemsForCatalogCategoryResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Success
     */
    public GetItemsForCatalogCategoryResponse withGetCatalogItemResponseCollectionCompoundDocument(GetCatalogItemResponseCollectionCompoundDocument getCatalogItemResponseCollectionCompoundDocument) {
        Utils.checkNotNull(getCatalogItemResponseCollectionCompoundDocument, "getCatalogItemResponseCollectionCompoundDocument");
     ...
     * Success
     */
    public GetItemsForCatalogCategoryResponse withGetCatalogItemResponseCollectionCompoundDocument(Optional<? extends GetCatalogItemResponseCollectionCompoundDocument> getCatalogItemResponseCollectionCompoundDocument) {
        Utils.checkNotNull(getCatalogItemResponseCollectionCompoundDocument, "getCatalogItemResponseCollectionCompoundDocument");
        this.getCatalogItemResponseCollectionCompoundDocument = getCatalogItemResponseCollectionCompoundDocument;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetItemsForCatalogCategoryResponse other = (GetItemsForCatalogCategoryResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetItemsForCatalogCategoryResponse.class,
    ...
    public final static class Builder {
        ...
        public GetItemsForCatalogCategoryResponse build() {
            return new GetItemsForCatalogCategoryResponse(
                contentType,
                statusCode,
                rawResponse,
                getCatalogItemResponseCollectionCompoundDocument);
