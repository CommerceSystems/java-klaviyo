...
public class PatchSegmentPartialUpdateResponseAttributes {
    ...
    @JsonCreator
    public PatchSegmentPartialUpdateResponseAttributes(
     ...
     * A helpful name to label the segment
     */
    public PatchSegmentPartialUpdateResponseAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * A helpful name to label the segment
     */
    public PatchSegmentPartialUpdateResponseAttributes withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public PatchSegmentPartialUpdateResponseAttributes withDefinition(SegmentDefinition definition) {
        Utils.checkNotNull(definition, "definition");
        this.definition = Optional.ofNullable(definition);
        return this;
    }

    public PatchSegmentPartialUpdateResponseAttributes withDefinition(Optional<? extends SegmentDefinition> definition) {
        Utils.checkNotNull(definition, "definition");
        this.definition = definition;
        return this;
    }
     ...
     * Date and time when the segment was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PatchSegmentPartialUpdateResponseAttributes withCreated(OffsetDateTime created) {
        Utils.checkNotNull(created, "created");
     ...
     * Date and time when the segment was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PatchSegmentPartialUpdateResponseAttributes withCreated(JsonNullable<OffsetDateTime> created) {
        Utils.checkNotNull(created, "created");
        this.created = created;
        return this;
    }
     ...
     * Date and time when the segment was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PatchSegmentPartialUpdateResponseAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
     ...
     * Date and time when the segment was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public PatchSegmentPartialUpdateResponseAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }

    public PatchSegmentPartialUpdateResponseAttributes withIsActive(boolean isActive) {
        Utils.checkNotNull(isActive, "isActive");
        this.isActive = isActive;
        return this;
    }

    public PatchSegmentPartialUpdateResponseAttributes withIsProcessing(boolean isProcessing) {
        Utils.checkNotNull(isProcessing, "isProcessing");
        this.isProcessing = isProcessing;
        return this;
    }

    public PatchSegmentPartialUpdateResponseAttributes withIsStarred(boolean isStarred) {
        Utils.checkNotNull(isStarred, "isStarred");
        this.isStarred = isStarred;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchSegmentPartialUpdateResponseAttributes other = (PatchSegmentPartialUpdateResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchSegmentPartialUpdateResponseAttributes.class,
                "name", name,
    ...
    public final static class Builder {
        ...
        public PatchSegmentPartialUpdateResponseAttributes build() {
            return new PatchSegmentPartialUpdateResponseAttributes(
                name,
                definition,
                created,
                updated,
