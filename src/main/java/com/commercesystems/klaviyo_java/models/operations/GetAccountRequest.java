...
public class GetAccountRequest {
    ...
    private Optional<? extends List<QueryParamFieldsAccount>> fieldsAccount;
    ...
    @JsonIgnore
    public Optional<List<QueryParamFieldsAccount>> fieldsAccount() {
        return (Optional<List<QueryParamFieldsAccount>>) fieldsAccount;
    }
     ...
     * The ID of the account
     */
    public GetAccountRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
     */
    public GetAccountRequest withFieldsAccount(List<QueryParamFieldsAccount> fieldsAccount) {
        Utils.checkNotNull(fieldsAccount, "fieldsAccount");
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
     */
    public GetAccountRequest withFieldsAccount(Optional<? extends List<QueryParamFieldsAccount>> fieldsAccount) {
        Utils.checkNotNull(fieldsAccount, "fieldsAccount");
        this.fieldsAccount = fieldsAccount;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public GetAccountRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
         */
        public Builder fieldsAccount(List<QueryParamFieldsAccount> fieldsAccount) {
            Utils.checkNotNull(fieldsAccount, "fieldsAccount");
            this.fieldsAccount = Optional.ofNullable(fieldsAccount);
            return this;
        }
         ...
         * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
         */
        public Builder fieldsAccount(Optional<? extends List<QueryParamFieldsAccount>> fieldsAccount) {
            Utils.checkNotNull(fieldsAccount, "fieldsAccount");
            this.fieldsAccount = fieldsAccount;
            return this;
        }
