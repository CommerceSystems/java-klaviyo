...
public class PostCatalogItemCreateJobResponseAttributes {

    /**
     * Status of the asynchronous job.
     */
    @JsonProperty("status")
    private PostCatalogItemCreateJobResponseStatus status;
    ...
    @JsonCreator
    public PostCatalogItemCreateJobResponseAttributes(
            @JsonProperty("status") PostCatalogItemCreateJobResponseStatus status,
    ...
    public PostCatalogItemCreateJobResponseAttributes(
            PostCatalogItemCreateJobResponseStatus status,
     ...
     */
    @JsonIgnore
    public PostCatalogItemCreateJobResponseStatus status() {
        return status;
    }
     ...
     * Status of the asynchronous job.
     */
    public PostCatalogItemCreateJobResponseAttributes withStatus(PostCatalogItemCreateJobResponseStatus status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The date and time the job was created in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PostCatalogItemCreateJobResponseAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The total number of operations to be processed by the job. See `completed_count` for the job's current progress.
     */
    public PostCatalogItemCreateJobResponseAttributes withTotalCount(long totalCount) {
        Utils.checkNotNull(totalCount, "totalCount");
        this.totalCount = totalCount;
        return this;
    }
     ...
     * The total number of operations that have been completed by the job.
     */
    public PostCatalogItemCreateJobResponseAttributes withCompletedCount(long completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
     ...
     * The total number of operations that have been completed by the job.
     */
    public PostCatalogItemCreateJobResponseAttributes withCompletedCount(JsonNullable<Long> completedCount) {
        Utils.checkNotNull(completedCount, "completedCount");
        this.completedCount = completedCount;
        return this;
    }
     ...
     * The total number of operations that have failed as part of the job.
     */
    public PostCatalogItemCreateJobResponseAttributes withFailedCount(long failedCount) {
        Utils.checkNotNull(failedCount, "failedCount");
     ...
     * The total number of operations that have failed as part of the job.
     */
    public PostCatalogItemCreateJobResponseAttributes withFailedCount(JsonNullable<Long> failedCount) {
        Utils.checkNotNull(failedCount, "failedCount");
        this.failedCount = failedCount;
        return this;
    }
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PostCatalogItemCreateJobResponseAttributes withCompletedAt(OffsetDateTime completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
     ...
     * Date and time the job was completed in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PostCatalogItemCreateJobResponseAttributes withCompletedAt(JsonNullable<OffsetDateTime> completedAt) {
        Utils.checkNotNull(completedAt, "completedAt");
        this.completedAt = completedAt;
        return this;
    }
     ...
     * Array of errors encountered during the processing of the job.
     */
    public PostCatalogItemCreateJobResponseAttributes withErrors(List<APIJobErrorPayload> errors) {
        Utils.checkNotNull(errors, "errors");
     ...
     * Array of errors encountered during the processing of the job.
     */
    public PostCatalogItemCreateJobResponseAttributes withErrors(JsonNullable<? extends List<APIJobErrorPayload>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Date and time the job expires in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PostCatalogItemCreateJobResponseAttributes withExpiresAt(OffsetDateTime expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
     ...
     * Date and time the job expires in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     */
    public PostCatalogItemCreateJobResponseAttributes withExpiresAt(JsonNullable<OffsetDateTime> expiresAt) {
        Utils.checkNotNull(expiresAt, "expiresAt");
        this.expiresAt = expiresAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostCatalogItemCreateJobResponseAttributes other = (PostCatalogItemCreateJobResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostCatalogItemCreateJobResponseAttributes.class,
                "status", status,
                "createdAt", createdAt,
    ...
    public final static class Builder {
         ...
         * Status of the asynchronous job.
         */
        public Builder status(PostCatalogItemCreateJobResponseStatus status) {
            Utils.checkNotNull(status, "status");
            this.status = status;
            return this;
        }
        ...
        public PostCatalogItemCreateJobResponseAttributes build() {
            if (completedCount == null) {
                completedCount = _SINGLETON_VALUE_CompletedCount.value();
            }
            if (failedCount == null) {
                failedCount = _SINGLETON_VALUE_FailedCount.value();
            }            return new PostCatalogItemCreateJobResponseAttributes(
                status,
                createdAt,
                totalCount,
                completedCount,
