...
public class DeleteFlowRequest {
     ...
     * ID of the Flow to delete. Ex: XVTP5Q
     */
    public DeleteFlowRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public DeleteFlowRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteFlowRequest other = (DeleteFlowRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteFlowRequest.class,
                "id", id,
                "revision", revision);
    }
