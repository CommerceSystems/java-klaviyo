...
public class GetCreateVariantsJobsRequest {
    ...
    private Optional<? extends List<FieldsCatalogVariantBulkCreateJob>> fieldsCatalogVariantBulkCreateJob;
    ...
    @JsonCreator
    public GetCreateVariantsJobsRequest(
    ...
    @JsonIgnore
    public Optional<List<FieldsCatalogVariantBulkCreateJob>> fieldsCatalogVariantBulkCreateJob() {
        return (Optional<List<FieldsCatalogVariantBulkCreateJob>>) fieldsCatalogVariantBulkCreateJob;
    }
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
     */
    public GetCreateVariantsJobsRequest withFieldsCatalogVariantBulkCreateJob(List<FieldsCatalogVariantBulkCreateJob> fieldsCatalogVariantBulkCreateJob) {
        Utils.checkNotNull(fieldsCatalogVariantBulkCreateJob, "fieldsCatalogVariantBulkCreateJob");
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
     */
    public GetCreateVariantsJobsRequest withFieldsCatalogVariantBulkCreateJob(Optional<? extends List<FieldsCatalogVariantBulkCreateJob>> fieldsCatalogVariantBulkCreateJob) {
        Utils.checkNotNull(fieldsCatalogVariantBulkCreateJob, "fieldsCatalogVariantBulkCreateJob");
        this.fieldsCatalogVariantBulkCreateJob = fieldsCatalogVariantBulkCreateJob;
        return this;
    }
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;`status`: `equals`
     */
    public GetCreateVariantsJobsRequest withFilter(String filter) {
        Utils.checkNotNull(filter, "filter");
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;`status`: `equals`
     */
    public GetCreateVariantsJobsRequest withFilter(Optional<String> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#pagination
     */
    public GetCreateVariantsJobsRequest withPageCursor(String pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
     ...
     * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#pagination
     */
    public GetCreateVariantsJobsRequest withPageCursor(Optional<String> pageCursor) {
        Utils.checkNotNull(pageCursor, "pageCursor");
        this.pageCursor = pageCursor;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public GetCreateVariantsJobsRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCreateVariantsJobsRequest other = (GetCreateVariantsJobsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCreateVariantsJobsRequest.class,
    ...
    public final static class Builder {
         ...
         * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
         */
        public Builder fieldsCatalogVariantBulkCreateJob(List<FieldsCatalogVariantBulkCreateJob> fieldsCatalogVariantBulkCreateJob) {
            Utils.checkNotNull(fieldsCatalogVariantBulkCreateJob, "fieldsCatalogVariantBulkCreateJob");
            this.fieldsCatalogVariantBulkCreateJob = Optional.ofNullable(fieldsCatalogVariantBulkCreateJob);
            return this;
        }
         ...
         * For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets
         */
        public Builder fieldsCatalogVariantBulkCreateJob(Optional<? extends List<FieldsCatalogVariantBulkCreateJob>> fieldsCatalogVariantBulkCreateJob) {
            Utils.checkNotNull(fieldsCatalogVariantBulkCreateJob, "fieldsCatalogVariantBulkCreateJob");
            this.fieldsCatalogVariantBulkCreateJob = fieldsCatalogVariantBulkCreateJob;
            return this;
        }
        ...
        public GetCreateVariantsJobsRequest build() {
            if (revision == null) {
                revision = _SINGLETON_VALUE_Revision.value();
            }            return new GetCreateVariantsJobsRequest(
                fieldsCatalogVariantBulkCreateJob,
                filter,
                pageCursor,
                revision);
