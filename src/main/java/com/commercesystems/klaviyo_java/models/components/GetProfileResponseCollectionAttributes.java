...
public class GetProfileResponseCollectionAttributes {
    ...
    @JsonCreator
    public GetProfileResponseCollectionAttributes(
    ...
    public GetProfileResponseCollectionAttributes withSubscriptions(Subscriptions subscriptions) {
        Utils.checkNotNull(subscriptions, "subscriptions");
        this.subscriptions = Optional.ofNullable(subscriptions);
        return this;
    }

    public GetProfileResponseCollectionAttributes withSubscriptions(Optional<? extends Subscriptions> subscriptions) {
        Utils.checkNotNull(subscriptions, "subscriptions");
        this.subscriptions = subscriptions;
        return this;
    }

    public GetProfileResponseCollectionAttributes withPredictiveAnalytics(PredictiveAnalytics predictiveAnalytics) {
        Utils.checkNotNull(predictiveAnalytics, "predictiveAnalytics");
        this.predictiveAnalytics = Optional.ofNullable(predictiveAnalytics);
        return this;
    }

    public GetProfileResponseCollectionAttributes withPredictiveAnalytics(Optional<? extends PredictiveAnalytics> predictiveAnalytics) {
        Utils.checkNotNull(predictiveAnalytics, "predictiveAnalytics");
        this.predictiveAnalytics = predictiveAnalytics;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetProfileResponseCollectionAttributes other = (GetProfileResponseCollectionAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetProfileResponseCollectionAttributes.class,
    ...
    public final static class Builder {
        ...
        public GetProfileResponseCollectionAttributes build() {
            return new GetProfileResponseCollectionAttributes(
                subscriptions,
                predictiveAnalytics);
        }
    }
