...
public class VideoBlock {
    ...
    public VideoBlock(
            ...
            @JsonProperty("type") VideoEnum type,
    ...
    public VideoBlock withContentType(BlockEnum contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }

    public VideoBlock withType(VideoEnum type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }

    public VideoBlock withData(String data) {
        Utils.checkNotNull(data, "data");
        this.data = Optional.ofNullable(data);
        return this;
    }

    public VideoBlock withData(Optional<String> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(VideoBlock.class,
    ...
    public final static class Builder {
        ...
        public Builder type(VideoEnum type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
