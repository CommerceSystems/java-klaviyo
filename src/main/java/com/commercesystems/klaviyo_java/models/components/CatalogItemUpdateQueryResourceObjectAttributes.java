...
public class CatalogItemUpdateQueryResourceObjectAttributes {
    ...
    private JsonNullable<? extends CatalogItemUpdateQueryResourceObjectCustomMetadata> customMetadata;
    ...
    @JsonCreator
    public CatalogItemUpdateQueryResourceObjectAttributes(
            ...
            @JsonProperty("custom_metadata") JsonNullable<? extends CatalogItemUpdateQueryResourceObjectCustomMetadata> customMetadata,
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<CatalogItemUpdateQueryResourceObjectCustomMetadata> customMetadata() {
        return (JsonNullable<CatalogItemUpdateQueryResourceObjectCustomMetadata>) customMetadata;
    }
     ...
     * The title of the catalog item.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the catalog item.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withTitle(JsonNullable<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * This field can be used to set the price on the catalog item, which is what gets displayed for the item when included in emails. For most price-update use cases, you will also want to update the `price` on any child variants, using the [Update Catalog Variant Endpoint](https://developers.klaviyo.com/en/reference/update_catalog_variant).
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withPrice(double price) {
        Utils.checkNotNull(price, "price");
     ...
     * This field can be used to set the price on the catalog item, which is what gets displayed for the item when included in emails. For most price-update use cases, you will also want to update the `price` on any child variants, using the [Update Catalog Variant Endpoint](https://developers.klaviyo.com/en/reference/update_catalog_variant).
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withPrice(JsonNullable<Double> price) {
        Utils.checkNotNull(price, "price");
        this.price = price;
        return this;
    }
     ...
     * A description of the catalog item.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A description of the catalog item.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withDescription(JsonNullable<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
     ...
     * URL pointing to the location of the catalog item on your website.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withUrl(String url) {
        Utils.checkNotNull(url, "url");
     ...
     * URL pointing to the location of the catalog item on your website.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withUrl(JsonNullable<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
     ...
     * URL pointing to the location of a full image of the catalog item.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withImageFullUrl(String imageFullUrl) {
        Utils.checkNotNull(imageFullUrl, "imageFullUrl");
     ...
     * URL pointing to the location of a full image of the catalog item.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withImageFullUrl(JsonNullable<String> imageFullUrl) {
        Utils.checkNotNull(imageFullUrl, "imageFullUrl");
        this.imageFullUrl = imageFullUrl;
        return this;
    }
     ...
     * URL pointing to the location of an image thumbnail of the catalog item
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withImageThumbnailUrl(String imageThumbnailUrl) {
        Utils.checkNotNull(imageThumbnailUrl, "imageThumbnailUrl");
     ...
     * URL pointing to the location of an image thumbnail of the catalog item
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withImageThumbnailUrl(JsonNullable<String> imageThumbnailUrl) {
        Utils.checkNotNull(imageThumbnailUrl, "imageThumbnailUrl");
        this.imageThumbnailUrl = imageThumbnailUrl;
        return this;
    }
     ...
     * List of URLs pointing to the locations of images of the catalog item.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withImages(List<String> images) {
        Utils.checkNotNull(images, "images");
     ...
     * List of URLs pointing to the locations of images of the catalog item.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withImages(JsonNullable<? extends List<String>> images) {
        Utils.checkNotNull(images, "images");
        this.images = images;
        return this;
    }
     ...
     * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withCustomMetadata(CatalogItemUpdateQueryResourceObjectCustomMetadata customMetadata) {
        Utils.checkNotNull(customMetadata, "customMetadata");
     ...
     * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withCustomMetadata(JsonNullable<? extends CatalogItemUpdateQueryResourceObjectCustomMetadata> customMetadata) {
        Utils.checkNotNull(customMetadata, "customMetadata");
        this.customMetadata = customMetadata;
        return this;
    }
     ...
     * Boolean value indicating whether the catalog item is published.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withPublished(boolean published) {
        Utils.checkNotNull(published, "published");
     ...
     * Boolean value indicating whether the catalog item is published.
     */
    public CatalogItemUpdateQueryResourceObjectAttributes withPublished(JsonNullable<Boolean> published) {
        Utils.checkNotNull(published, "published");
        this.published = published;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CatalogItemUpdateQueryResourceObjectAttributes other = (CatalogItemUpdateQueryResourceObjectAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CatalogItemUpdateQueryResourceObjectAttributes.class,
                "title", title,
                "price", price,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends CatalogItemUpdateQueryResourceObjectCustomMetadata> customMetadata = JsonNullable.undefined();
         ...
         * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
         */
        public Builder customMetadata(CatalogItemUpdateQueryResourceObjectCustomMetadata customMetadata) {
            Utils.checkNotNull(customMetadata, "customMetadata");
            this.customMetadata = JsonNullable.of(customMetadata);
            return this;
        }
         ...
         * Flat JSON blob to provide custom metadata about the catalog item. May not exceed 100kb.
         */
        public Builder customMetadata(JsonNullable<? extends CatalogItemUpdateQueryResourceObjectCustomMetadata> customMetadata) {
            Utils.checkNotNull(customMetadata, "customMetadata");
            this.customMetadata = customMetadata;
            return this;
        }
        ...
        public CatalogItemUpdateQueryResourceObjectAttributes build() {
            return new CatalogItemUpdateQueryResourceObjectAttributes(
                title,
                price,
                description,
                url,
