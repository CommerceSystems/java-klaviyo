...
public class GetSegmentListResponseCollectionCompoundDocumentAttributes {
    ...
    @JsonCreator
    public GetSegmentListResponseCollectionCompoundDocumentAttributes(
     ...
     * A helpful name to label the segment
     */
    public GetSegmentListResponseCollectionCompoundDocumentAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * A helpful name to label the segment
     */
    public GetSegmentListResponseCollectionCompoundDocumentAttributes withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public GetSegmentListResponseCollectionCompoundDocumentAttributes withDefinition(SegmentDefinition definition) {
        Utils.checkNotNull(definition, "definition");
        this.definition = Optional.ofNullable(definition);
        return this;
    }

    public GetSegmentListResponseCollectionCompoundDocumentAttributes withDefinition(Optional<? extends SegmentDefinition> definition) {
        Utils.checkNotNull(definition, "definition");
        this.definition = definition;
        return this;
    }
     ...
     * Date and time when the segment was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public GetSegmentListResponseCollectionCompoundDocumentAttributes withCreated(OffsetDateTime created) {
        Utils.checkNotNull(created, "created");
     ...
     * Date and time when the segment was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public GetSegmentListResponseCollectionCompoundDocumentAttributes withCreated(JsonNullable<OffsetDateTime> created) {
        Utils.checkNotNull(created, "created");
        this.created = created;
        return this;
    }
     ...
     * Date and time when the segment was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public GetSegmentListResponseCollectionCompoundDocumentAttributes withUpdated(OffsetDateTime updated) {
        Utils.checkNotNull(updated, "updated");
     ...
     * Date and time when the segment was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     */
    public GetSegmentListResponseCollectionCompoundDocumentAttributes withUpdated(JsonNullable<OffsetDateTime> updated) {
        Utils.checkNotNull(updated, "updated");
        this.updated = updated;
        return this;
    }

    public GetSegmentListResponseCollectionCompoundDocumentAttributes withIsActive(boolean isActive) {
        Utils.checkNotNull(isActive, "isActive");
        this.isActive = isActive;
        return this;
    }

    public GetSegmentListResponseCollectionCompoundDocumentAttributes withIsProcessing(boolean isProcessing) {
        Utils.checkNotNull(isProcessing, "isProcessing");
        this.isProcessing = isProcessing;
        return this;
    }

    public GetSegmentListResponseCollectionCompoundDocumentAttributes withIsStarred(boolean isStarred) {
        Utils.checkNotNull(isStarred, "isStarred");
        this.isStarred = isStarred;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSegmentListResponseCollectionCompoundDocumentAttributes other = (GetSegmentListResponseCollectionCompoundDocumentAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSegmentListResponseCollectionCompoundDocumentAttributes.class,
                "name", name,
    ...
    public final static class Builder {
        ...
        public GetSegmentListResponseCollectionCompoundDocumentAttributes build() {
            return new GetSegmentListResponseCollectionCompoundDocumentAttributes(
                name,
                definition,
                created,
                updated,
