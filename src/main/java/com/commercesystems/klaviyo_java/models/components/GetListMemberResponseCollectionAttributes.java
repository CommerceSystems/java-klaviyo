...
public class GetListMemberResponseCollectionAttributes {
    ...
    public GetListMemberResponseCollectionAttributes withSubscriptions(Subscriptions subscriptions) {
        Utils.checkNotNull(subscriptions, "subscriptions");
        this.subscriptions = Optional.ofNullable(subscriptions);
        return this;
    }

    public GetListMemberResponseCollectionAttributes withSubscriptions(Optional<? extends Subscriptions> subscriptions) {
        Utils.checkNotNull(subscriptions, "subscriptions");
        this.subscriptions = subscriptions;
        return this;
    }

    public GetListMemberResponseCollectionAttributes withPredictiveAnalytics(PredictiveAnalytics predictiveAnalytics) {
        Utils.checkNotNull(predictiveAnalytics, "predictiveAnalytics");
        this.predictiveAnalytics = Optional.ofNullable(predictiveAnalytics);
        return this;
    }

    public GetListMemberResponseCollectionAttributes withPredictiveAnalytics(Optional<? extends PredictiveAnalytics> predictiveAnalytics) {
        Utils.checkNotNull(predictiveAnalytics, "predictiveAnalytics");
        this.predictiveAnalytics = predictiveAnalytics;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public GetListMemberResponseCollectionAttributes build() {
            return new GetListMemberResponseCollectionAttributes(
                subscriptions,
                predictiveAnalytics);
        }
    }
