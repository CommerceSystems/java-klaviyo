...
public class GetCampaignResponseAttributes {
    ...
    private GetCampaignResponseSendOptions sendOptions;

    /**
     * The tracking options associated with the campaign
     */
    @JsonProperty("tracking_options")
    private GetCampaignResponseTrackingOptions trackingOptions;
    ...
    @JsonCreator
    public GetCampaignResponseAttributes(
            @JsonProperty("name") String name,
            @JsonProperty("status") String status,
            @JsonProperty("archived") boolean archived,
            @JsonProperty("audiences") AudiencesSubObject audiences,
            @JsonProperty("send_options") GetCampaignResponseSendOptions sendOptions,
            @JsonProperty("tracking_options") GetCampaignResponseTrackingOptions trackingOptions,
    ...
    public GetCampaignResponseAttributes(
            ...
            GetCampaignResponseSendOptions sendOptions,
            GetCampaignResponseTrackingOptions trackingOptions,
     ...
     */
    @JsonIgnore
    public GetCampaignResponseSendOptions sendOptions() {
        return sendOptions;
    }
     ...
     */
    @JsonIgnore
    public GetCampaignResponseTrackingOptions trackingOptions() {
     ...
     * The campaign name
     */
    public GetCampaignResponseAttributes withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The current status of the campaign
     */
    public GetCampaignResponseAttributes withStatus(String status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Whether the campaign has been archived or not
     */
    public GetCampaignResponseAttributes withArchived(boolean archived) {
        Utils.checkNotNull(archived, "archived");
        this.archived = archived;
        return this;
    }

    public GetCampaignResponseAttributes withAudiences(AudiencesSubObject audiences) {
        Utils.checkNotNull(audiences, "audiences");
        this.audiences = audiences;
        return this;
    }
     ...
     * Options to use when sending a campaign
     */
    public GetCampaignResponseAttributes withSendOptions(GetCampaignResponseSendOptions sendOptions) {
        Utils.checkNotNull(sendOptions, "sendOptions");
        this.sendOptions = sendOptions;
        return this;
    }
     ...
     * The tracking options associated with the campaign
     */
    public GetCampaignResponseAttributes withTrackingOptions(GetCampaignResponseTrackingOptions trackingOptions) {
        Utils.checkNotNull(trackingOptions, "trackingOptions");
        this.trackingOptions = trackingOptions;
        return this;
    }

    public GetCampaignResponseAttributes withSendStrategy(SendStrategySubObject sendStrategy) {
        Utils.checkNotNull(sendStrategy, "sendStrategy");
        this.sendStrategy = sendStrategy;
        return this;
    }
     ...
     * The datetime when the campaign was created
     */
    public GetCampaignResponseAttributes withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * The datetime when the campaign was scheduled for future sending
     */
    public GetCampaignResponseAttributes withScheduledAt(OffsetDateTime scheduledAt) {
        Utils.checkNotNull(scheduledAt, "scheduledAt");
     ...
     * The datetime when the campaign was scheduled for future sending
     */
    public GetCampaignResponseAttributes withScheduledAt(JsonNullable<OffsetDateTime> scheduledAt) {
        Utils.checkNotNull(scheduledAt, "scheduledAt");
        this.scheduledAt = scheduledAt;
        return this;
    }
     ...
     * The datetime when the campaign was last updated by a user or the system
     */
    public GetCampaignResponseAttributes withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * The datetime when the campaign will be / was sent or None if not yet scheduled by a send_job.
     */
    public GetCampaignResponseAttributes withSendTime(OffsetDateTime sendTime) {
        Utils.checkNotNull(sendTime, "sendTime");
     ...
     * The datetime when the campaign will be / was sent or None if not yet scheduled by a send_job.
     */
    public GetCampaignResponseAttributes withSendTime(JsonNullable<OffsetDateTime> sendTime) {
        Utils.checkNotNull(sendTime, "sendTime");
        this.sendTime = sendTime;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCampaignResponseAttributes other = (GetCampaignResponseAttributes) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCampaignResponseAttributes.class,
                "name", name,
                "status", status,
                "archived", archived,
                "audiences", audiences,
    ...
    public final static class Builder {
         ...
         * Options to use when sending a campaign
         */
        public Builder sendOptions(GetCampaignResponseSendOptions sendOptions) {
            Utils.checkNotNull(sendOptions, "sendOptions");
            this.sendOptions = sendOptions;
            return this;
        }
         ...
         * The tracking options associated with the campaign
         */
        public Builder trackingOptions(GetCampaignResponseTrackingOptions trackingOptions) {
            Utils.checkNotNull(trackingOptions, "trackingOptions");
            this.trackingOptions = trackingOptions;
            return this;
        }
        ...
        public GetCampaignResponseAttributes build() {
            return new GetCampaignResponseAttributes(
                name,
                status,
                archived,
                audiences,
