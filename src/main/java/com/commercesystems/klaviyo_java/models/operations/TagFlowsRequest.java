...
public class TagFlowsRequest {
     ...
     * The Tag ID
     */
    public TagFlowsRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * API endpoint revision (format: YYYY-MM-DD[.suffix])
     */
    public TagFlowsRequest withRevision(String revision) {
        Utils.checkNotNull(revision, "revision");
        this.revision = revision;
        return this;
    }

    public TagFlowsRequest withTagFlowOp(TagFlowOp tagFlowOp) {
        Utils.checkNotNull(tagFlowOp, "tagFlowOp");
        this.tagFlowOp = tagFlowOp;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TagFlowsRequest other = (TagFlowsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TagFlowsRequest.class,
                "id", id,
                "revision", revision,
                "tagFlowOp", tagFlowOp);
    }
    ...
    public final static class Builder {
        ...
        public TagFlowsRequest build() {
            if (revision == null) {
                revision = _SINGLETON_VALUE_Revision.value();
            }            return new TagFlowsRequest(
                id,
                revision,
                tagFlowOp);
        }
